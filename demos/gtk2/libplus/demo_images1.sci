...
function demo_images1() 
  ...
  // diff to the depth of our widgets. 
    ...
    nsp_logo = getenv('NSP')+'/demos/gtk2/libplus/nsp.xpm';
    // pbs de plugins ? 
    // nsp_logo = getenv('NSP')+'/demos/gtk2/libplus/nsp.png';
    // nsp_logo = getenv('NSP')+'/demos/gtk2/libplus/nsp.svg';
  ...
  add_image(demo_image_from_pixmap(window),"file.xpm ->pixmap",vbox)
