...
struct _opt_simul_data
{
  NspObject *args; /* extra arguments to pass the objective function 
		    * must be kept at first position thus opt_simul_data can be casted to
		    * NspObject *
		    */
