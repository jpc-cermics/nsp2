/* 
 * Copyright (C) 1998-2008 Claude Lemarechal, INRIA. (PB)
 * 
 * n1gc2: derived from a free version of va14a Harwell free.
 *
...
/*!but 
 *    gradient conjugue avec restarts controles, suivant une idee de Beale
 *!origine 
