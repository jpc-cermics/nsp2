...
static int get_solver_options(Stack stack, NspHash *solver_options, nsp_clp_params *clp_params);
...
static int get_solver_options(Stack stack, NspHash *solver_options, nsp_clp_params *clp_params)
{
  ...
  clp_params->solverchoice = Min(Max(solverchoice,3),1);
