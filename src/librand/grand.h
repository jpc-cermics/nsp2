...
extern int init_rand_geom(double p, GeomStruct *G);
extern unsigned int rand_geom(GeomStruct *G);
extern unsigned int rand_geom_direct(double p);
...
extern int init_rand_nc_chi2(double nu, double xnonc, NcChi2Struct *C);
extern double rand_nc_chi2(NcChi2Struct *C);
extern double rand_nc_chi2_direct(double nu, double xnonc);
...
extern int init_rand_gamma(double a, GammaStruct *G);
extern double rand_gamma(GammaStruct *G);
extern double rand_gamma_direct(double a);
extern int init_rand_beta(double a, double b, BetaStruct *B);
extern double rand_beta(BetaStruct *B);
extern double rand_beta_direct(double a, double b);
extern int init_rand_chi2(double a, Chi2Struct *C);
extern double rand_chi2(Chi2Struct *C);
extern double rand_chi2_direct(double a);
extern int init_rand_F(double nu1, double nu2, FStruct *F);
extern double rand_F(FStruct *F);
extern double rand_F_direct(double nu1, double nu2);
extern int init_rand_nc_F(double nu1, double nu2, double xnonc, NcFStruct *E);
extern double rand_nc_F(NcFStruct *E);
extern double rand_nc_F_direct(double nu1, double nu2, double xnonc);
...
extern int init_poi_trd(double mu, PoissonStruct *P);
extern int poi_trd(PoissonStruct *P);
extern int poi_trd_direct(double mu);
extern int init_rand_bin(int n, double p, BinomialStruct *B);
extern int rand_bin(BinomialStruct *B);
extern int rand_bin_direct(int n, double p);
extern int rand_ignbin (int *n, double *pp);
extern int rand_ignnbn (int n, double p);
extern int init_rand_nbn(int n, double p, NbnStruct *N);
extern int rand_nbn(NbnStruct *N);
extern int rand_nbn_direct(int n, double p);
...
extern void rand_ndgauss(double *Mean, double *C, double *res, int n);
