/* rfftf1.f -- translated by f2c (version 19961017).
 *   
...
static int fftpack_radf2 (int *ido, int *l1, double *cc, double *ch,
			  double *wa1);
static int fftpack_radf3 (int *ido, int *l1, double *cc, double *ch,
			  double *wa1, double *wa2);
static int fftpack_radf4 (int *ido, int *l1, double *cc, double *ch,
			  double *wa1, double *wa2, double *wa3);
static int fftpack_radf5 (int *ido, int *l1, double *cc, double *ch,
			  double *wa1, double *wa2, double *wa3, double *wa4);

static int fftpack_radfg (int *ido, int *ip, int *l1, int *idl1, double *cc,
			  double *c1, double *c2, double *ch, double *ch2,
			  double *wa);

/* Subroutine */ int
fftpack_rfftf1 (int *n, double *c__, double *ch, double *wa, int *ifac)
{
  ...
  for (k1 = 1; k1 <= i__1; ++k1)
      ...
      if (na != 0)
	{
      ...
      fftpack_radf4 (&ido, &l1, &c__[1], &ch[1], &wa[iw], &wa[ix2], &wa[ix3]);
      goto L110;
    L101:
      fftpack_radf4 (&ido, &l1, &ch[1], &c__[1], &wa[iw], &wa[ix2], &wa[ix3]);
      goto L110;
    L102:
      if (ip != 2)
	{
      ...
      if (na != 0)
	{
      ...
      fftpack_radf2 (&ido, &l1, &c__[1], &ch[1], &wa[iw]);
      goto L110;
    L103:
      fftpack_radf2 (&ido, &l1, &ch[1], &c__[1], &wa[iw]);
      goto L110;
    L104:
      if (ip != 3)
	{
      ...
      if (na != 0)
	{
      ...
      fftpack_radf3 (&ido, &l1, &c__[1], &ch[1], &wa[iw], &wa[ix2]);
      goto L110;
    L105:
      fftpack_radf3 (&ido, &l1, &ch[1], &c__[1], &wa[iw], &wa[ix2]);
      goto L110;
    L106:
      if (ip != 5)
	{
      ...
      if (na != 0)
	{
      ...
      fftpack_radf5 (&ido, &l1, &c__[1], &ch[1], &wa[iw], &wa[ix2], &wa[ix3],
		     &wa[ix4]);
      goto L110;
    L107:
      fftpack_radf5 (&ido, &l1, &ch[1], &c__[1], &wa[iw], &wa[ix2], &wa[ix3],
		     &wa[ix4]);
      goto L110;
    L108:
      if (ido == 1)
      ...
      if (na != 0)
	{
      ...
      fftpack_radfg (&ido, &ip, &l1, &idl1, &c__[1], &c__[1], &c__[1], &ch[1],
		     &ch[1], &wa[iw]);
      na = 1;
      goto L110;
    L109:
      fftpack_radfg (&ido, &ip, &l1, &idl1, &ch[1], &ch[1], &ch[1], &c__[1],
		     &c__[1], &wa[iw]);
      na = 0;
    L110:
      l2 = l1;
...
/* radf2.f -- translated by f2c (version 19961017).
 *   
 *   -lf2c -lm (in that order)
 */
...
/* Subroutine */ int
fftpack_radf2 (int *ido, int *l1, double *cc, double *ch, double *wa1)
{
  /* System generated locals */
  ...
  for (k = 1; k <= i__1; ++k)
    {
      ch[((k << 1) + 1) * ch_dim1 + 1] =
	cc[(k + cc_dim2) * cc_dim1 + 1] + cc[(k + (cc_dim2 << 1)) * cc_dim1 +
					     1];
 ...
 L102:
  ...
  for (k = 1; k <= i__1; ++k)
      ...
      for (i__ = 3; i__ <= i__2; i__ += 2)
	{
	  ic = idp2 - i__;
	  tr2 =
	    wa1[i__ - 2] * cc[i__ - 1 + (k + (cc_dim2 << 1)) * cc_dim1] +
	    wa1[i__ - 1] * cc[i__ + (k + (cc_dim2 << 1)) * cc_dim1];
	  ti2 =
	    wa1[i__ - 2] * cc[i__ + (k + (cc_dim2 << 1)) * cc_dim1] -
	    wa1[i__ - 1] * cc[i__ - 1 + (k + (cc_dim2 << 1)) * cc_dim1];
	  ch[i__ + ((k << 1) + 1) * ch_dim1] =
	    cc[i__ + (k + cc_dim2) * cc_dim1] + ti2;
	  ch[ic + ((k << 1) + 2) * ch_dim1] =
	    ti2 - cc[i__ + (k + cc_dim2) * cc_dim1];
 ...
 L105:
  ...
  for (k = 1; k <= i__1; ++k)
    {
      ch[((k << 1) + 2) * ch_dim1 + 1] =
	-cc[*ido + (k + (cc_dim2 << 1)) * cc_dim1];
      ch[*ido + ((k << 1) + 1) * ch_dim1] =
	cc[*ido + (k + cc_dim2) * cc_dim1];
      /* L106: */
    }
 L107:
  return 0;
}				/* radf2_ */
/* radf3.f -- translated by f2c (version 19961017).
 *   
 *   -lf2c -lm (in that order)
 */
...
/* Subroutine */ int
fftpack_radf3 (int *ido, int *l1, double *cc, double *ch, double *wa1,
	       double *wa2)
{
  /* Initialized data */
  ...
  for (k = 1; k <= i__1; ++k)
	...
	taui * (cc[(k + cc_dim2 * 3) * cc_dim1 + 1] -
		cc[(k + (cc_dim2 << 1)) * cc_dim1 + 1]);
      ch[*ido + (k * 3 + 2) * ch_dim1] =
	cc[(k + cc_dim2) * cc_dim1 + 1] + taur * cr2;
      /* L101: */
    }
  if (*ido == 1)
    {
  ...
  for (k = 1; k <= i__1; ++k)
      ...
      for (i__ = 3; i__ <= i__2; i__ += 2)
	{
	  ...
	  di2 =
	    ...
	    wa1[i__ - 1] * cc[i__ - 1 + (k + (cc_dim2 << 1)) * cc_dim1];
	  dr3 =
	    wa2[i__ - 2] * cc[i__ - 1 + (k + cc_dim2 * 3) * cc_dim1] +
	    wa2[i__ - 1] * cc[i__ + (k + cc_dim2 * 3) * cc_dim1];
	  di3 =
	    wa2[i__ - 2] * cc[i__ + (k + cc_dim2 * 3) * cc_dim1] - wa2[i__ -
								       1] *
	    cc[i__ - 1 + (k + cc_dim2 * 3) * cc_dim1];
	  cr2 = dr2 + dr3;
	  ci2 = di2 + di3;
	  ch[i__ - 1 + (k * 3 + 1) * ch_dim1] =
	    cc[i__ - 1 + (k + cc_dim2) * cc_dim1] + cr2;
	  ch[i__ + (k * 3 + 1) * ch_dim1] =
	    cc[i__ + (k + cc_dim2) * cc_dim1] + ci2;
...
/* radf4.f -- translated by f2c (version 19961017).
 *   
 *   -lf2c -lm (in that order)
 */
...
/* Subroutine */ int
fftpack_radf4 (int *ido, int *l1, double *cc, double *ch, double *wa1,
	       double *wa2, double *wa3)
{
  /* Initialized data */

  static double hsqt2 = .7071067811865475244;
  ...
  for (k = 1; k <= i__1; ++k)
      ...
      for (i__ = 3; i__ <= i__2; i__ += 2)
	{
	  ...
	  ci3 =
	    ...
	    cc[i__ - 1 + (k + cc_dim2 * 3) * cc_dim1];
	  cr4 =
	    wa3[i__ - 2] * cc[i__ - 1 + (k + (cc_dim2 << 2)) * cc_dim1] +
	    wa3[i__ - 1] * cc[i__ + (k + (cc_dim2 << 2)) * cc_dim1];
	  ci4 =
	    wa3[i__ - 2] * cc[i__ + (k + (cc_dim2 << 2)) * cc_dim1] -
 ...
 L105:
  ...
  for (k = 1; k <= i__1; ++k)
    {
      ti1 =
	-hsqt2 * (cc[*ido + (k + (cc_dim2 << 1)) * cc_dim1] +
		  cc[*ido + (k + (cc_dim2 << 2)) * cc_dim1]);
      tr1 =
	hsqt2 * (cc[*ido + (k + (cc_dim2 << 1)) * cc_dim1] -
		 cc[*ido + (k + (cc_dim2 << 2)) * cc_dim1]);
      ch[*ido + ((k << 2) + 1) * ch_dim1] =
	tr1 + cc[*ido + (k + cc_dim2) * cc_dim1];
      ch[*ido + ((k << 2) + 3) * ch_dim1] =
	cc[*ido + (k + cc_dim2) * cc_dim1] - tr1;
      ch[((k << 2) + 2) * ch_dim1 + 1] =
	ti1 - cc[*ido + (k + cc_dim2 * 3) * cc_dim1];
      ch[((k << 2) + 4) * ch_dim1 + 1] =
	ti1 + cc[*ido + (k + cc_dim2 * 3) * cc_dim1];
      /* L106: */
    }
...
/* radf5.f -- translated by f2c (version 19961017).
 *   
 *   -lf2c -lm (in that order)
 */
...
/* Subroutine */ int
fftpack_radf5 (int *ido, int *l1, double *cc, double *ch, double *wa1,
	       double *wa2, double *wa3, double *wa4)
{
  ...
  for (k = 1; k <= i__1; ++k)
	...
	cc[(k + cc_dim2 * 3) * cc_dim1 + 1];
      ch[(k * 5 + 1) * ch_dim1 + 1] =
	cc[(k + cc_dim2) * cc_dim1 + 1] + cr2 + cr3;
  ...
  for (k = 1; k <= i__1; ++k)
      ...
      for (i__ = 3; i__ <= i__2; i__ += 2)
	{
	  ...
	  di4 =
	    ...
	    wa3[i__ - 1] * cc[i__ - 1 + (k + (cc_dim2 << 2)) * cc_dim1];
	  dr5 =
	    wa4[i__ - 2] * cc[i__ - 1 + (k + cc_dim2 * 5) * cc_dim1] +
	    wa4[i__ - 1] * cc[i__ + (k + cc_dim2 * 5) * cc_dim1];
	  di5 =
	    wa4[i__ - 2] * cc[i__ + (k + cc_dim2 * 5) * cc_dim1] - wa4[i__ -
								       1] *
	    cc[i__ - 1 + (k + cc_dim2 * 5) * cc_dim1];
	  cr2 = dr2 + dr5;
	  ci5 = dr5 - dr2;
	  cr5 = di2 - di5;
	  ci2 = di2 + di5;
	  ...
	  ch[i__ + (k * 5 + 1) * ch_dim1] =
	    cc[i__ + (k + cc_dim2) * cc_dim1] + ci2 + ci3;
	  tr2 =
	    cc[i__ - 1 + (k + cc_dim2) * cc_dim1] + tr11 * cr2 + tr12 * cr3;
	  ti2 = cc[i__ + (k + cc_dim2) * cc_dim1] + tr11 * ci2 + tr12 * ci3;
	  tr3 =
	    cc[i__ - 1 + (k + cc_dim2) * cc_dim1] + tr12 * cr2 + tr11 * cr3;
...
/* radfg.f -- translated by f2c (version 19961017).
 *   
 *   -lf2c -lm (in that order)
 */
...
/* Subroutine */ int
fftpack_radfg (int *ido, int *ip, int *l1, int *idl1, double *cc, double *c1,
	       double *c2, double *ch, double *ch2, double *wa)
{
  ...
  /* Local variables */
  int idij, ipph, i__, j, k, l, j2, ic, jc, lc, ik, is;
  ...
  for (j = 2; j <= i__1; ++j)
      ...
      for (k = 1; k <= i__2; ++k)
	{
	  ...
	  for (i__ = 3; i__ <= i__3; i__ += 2)
		...
		ch[i__ - 1 + (k + j * ch_dim2) * ch_dim1] + ch[i__ - 1 +
							       (k +
								jc *
								ch_dim2) *
							       ch_dim1];
	      c1[i__ - 1 + (k + jc * c1_dim2) * c1_dim1] =
		ch[i__ + (k + j * ch_dim2) * ch_dim1] - ch[i__ +
							   (k +
							    jc * ch_dim2) *
							   ch_dim1];
		...
		ch[i__ - 1 + (k + jc * ch_dim2) * ch_dim1] - ch[i__ - 1 +
								(k +
								 j *
								 ch_dim2) *
								ch_dim1];
 ...
 L121:
  ...
  for (l = 2; l <= i__1; ++l)
	...
	{
	  ch2[ik + l * ch2_dim1] =
	    c2[ik + c2_dim1] + ar1 * c2[ik + (c2_dim1 << 1)];
  ...
  for (j = 2; j <= i__1; ++j)
      ...
      for (k = 1; k <= i__2; ++k)
	{
	  ...
	  for (i__ = 3; i__ <= i__3; i__ += 2)
		...
		ch[i__ + (k + jc * ch_dim2) * ch_dim1] - ch[i__ +
							    (k +
							     j * ch_dim2) *
							    ch_dim1];
	      /* L138: */
