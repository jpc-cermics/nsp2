/* Copyright (C) 1998-2019 Chancelier Jean-Philippe */
#include <stdio.h>
#include <setjmp.h>
#include <signal.h>
#include <string.h>
...
extern void test_plot  (void);  
extern void test_apropos  (void);  
extern void test_menu  (void);  
extern void test_quit  (void);  
extern void test_loop  (void);  
extern void test_message  (void);  
extern void test_click  (void);  
extern void test_events  (void);  
extern void test_xinfo  (void);  
extern void test_xgc  (void);  
extern void LTest  (char *x0);  
...
extern void C2F (cvstr) (int *n, int *line, char *str, int *job, long int lstr);  
