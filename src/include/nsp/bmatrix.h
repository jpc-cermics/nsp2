...
extern void nsp_bmatrix_info(NspBMatrix *BMat, int indent,const char *name, int rec_level); 
extern void nsp_bmatrix_print(NspBMatrix *BMat, int indent,const char *name, int rec_level); 
