...
static int link_set_pos (NspLink *R, const double pt[2]); 
static void link_get_pos (NspLink *R, double pt[2]); 
static void link_resize (NspLink *R, const double size[2]); 
static void link_update_locks (NspLink *R); 
static int link_contains_pt (const NspLink *B, const double pt[2]); 
static int link_control_near_pt (const NspLink *B, const double pt[2], int *cp); 
static int link_lock_near_pt (const NspLink *B,const double pt[2], int *cp); 
static void link_move_control_init( NspLink *B,int cp,double ptc[2]);
static void link_move_control (void *F,NspLink *B, const double pt[2], int cp,double ptc[2]); 
