...
extern void nsp_compound_info(NspCompound *H, int indent,const char *name, int rec_level);
extern void nsp_compound_print(NspCompound *H, int indent,const char *name, int rec_level);
extern void nsp_compound_latex(NspCompound *H, int indent,const char *name, int rec_level);
