...
extern void nsp_smatrix_info(const NspSMatrix *Mat, int indent,char *name, int rec_level); 
extern void nsp_smatrix_print(const NspSMatrix *Mat, int indent,char *name, int rec_level); 
