...
extern int nsp_smatrix_set_submatrix_obsolete(NspSMatrix *A,const NspMatrix *Rows,const NspMatrix *Cols,const NspSMatrix *B); 
extern int nsp_smatrix_set_rows_obsolete(NspSMatrix *A, NspMatrix *Rows, NspSMatrix *B); 
extern NspSMatrix *nsp_smatrix_extract_obsolete(NspSMatrix *A, NspMatrix *Rows, NspMatrix *Cols); 
extern NspSMatrix *nsp_smatrix_extract_elements_obsolete(NspSMatrix *A, NspMatrix *Elts, int *err); 
extern NspSMatrix *nsp_smatrix_extract_columns_obsolete(NspSMatrix *A, NspMatrix *Cols, int *err); 
extern NspSMatrix *SMatLoopCol (char *str, NspSMatrix *Col, NspSMatrix *A, int icol, int *rep); 
extern NspSMatrix *nsp_smatrix_extract_rows_obsolete(NspSMatrix *A, NspMatrix *Rows, int *err); 
