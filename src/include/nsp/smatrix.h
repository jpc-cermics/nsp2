...
extern NspMatrix *nsp_smatrix_sort(NspSMatrix *A,int flag,nsp_const_string  str1,nsp_const_string str2); 
extern NspSMatrix *nsp_smatrix_split(nsp_const_string string, nsp_const_string splitChars); 
