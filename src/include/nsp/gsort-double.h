#ifndef NSP_INC_GSORT_DOUBLE
#define NSP_INC_GSORT_DOUBLE
 ...
 * with double == double or int
 * 
 sed -e "s/double/double/g" -e "s/NSP_INC_GSORT_DOUBLE/NSP_INC_GSORT_DOUBLE/" gsort-gen.h >! gsort-double.h
 sed -e "s/double/int/g" -e "s/NSP_INC_GSORT_DOUBLE/NSP_INC_GSORT_INT/" gsort-gen.h >! gsort-int.h
 *
 */
...
static void CNAME(ColSort,double)(double *a,int *ind,int flag,int n,int p,char dir)
{
  int i,j;
  if ( flag == 1) 
    {
...
static void CNAME(RowSort,double)(double *a,int *ind,int flag,int n,int p,char dir)
{  
  int i,j;
  if ( flag == 1) 
    {
...
static void CNAME(GlobalSort,double)(double *a,int *ind,int flag,int n,int p,char dir)
{  
  int i;
  if ( flag == 1) 
    {
...
static void CNAME(LexiRow,double)(double *a,int *ind,int flag,int n,int p,char dir)
{
  int i;
