...
extern void nsp_axis_draw  (BCG *Xgc, char mode, char scale, int grid_color, int bg, int flag);
extern void nsp_graphic_titles(BCG *Xgc,char *title,char *x,char *y);
