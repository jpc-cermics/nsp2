...
extern NspPMatrix *nsp_pmatrix_extract_rows_obsolete(NspPMatrix *A, NspMatrix *Rows, int *err); 
...
extern int nsp_pmatrix_set_rows_obsolete(NspPMatrix *A, NspMatrix *Rows, NspPMatrix *B); 
extern int nsp_pmatrix_set_submatrix_obsolete(NspPMatrix *A,const NspMatrix *Rows,const NspMatrix *Cols,const NspPMatrix *B); 
extern int nsp_pmatrix_setrc_obsolete(NspPMatrix *A, NspMatrix *Rows, NspMatrix *Cols, NspPMatrix *B); 
