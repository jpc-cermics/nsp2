...
extern int nsp_pmatrix_delete_elements(NspPMatrix *A, NspMatrix *Elts); 
extern int nsp_pmatrix_delete_rows(NspPMatrix *A, NspMatrix *Rows); 
...
extern void nsp_pmatrix_info(NspPMatrix *Mat, int indent,char *name, int rec_level); 
extern void nsp_pmatrix_print(NspPMatrix *Mat, int indent,char *name, int rec_level); 
