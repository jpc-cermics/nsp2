...
extern NspPMatrix *nsp_pmatrix_mult_p_m(NspPMatrix *A, NspMatrix *B);
extern NspPMatrix *nsp_pmatrix_mult_tt(NspPMatrix *A, NspPMatrix *B);
extern NspPMatrix *nsp_pmatrix_mult_tt_p_m(NspPMatrix *A, NspMatrix *B);
extern NspPMatrix *nsp_pmatrix_mult_tt_m_p(NspMatrix *A, NspPMatrix *B);
extern NspPMatrix *nsp_pmatrix_div_tt_p_m(NspPMatrix *A, NspMatrix *B,int flag);
extern NspPMatrix *nsp_pmatrix_div_tt_m_p(NspMatrix *A, NspPMatrix *B);
