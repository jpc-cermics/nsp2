...
extern NspCells *nsp_cells_clone(const char *name, NspCells *A, int m, int n);
...
extern int nsp_cells_set_submatrix_obsolete(NspCells *A,const NspMatrix *Rows,const NspMatrix *Cols,const NspCells *B); 
extern int nsp_cells_set_rows_obsolete(NspCells *A, NspMatrix *Rows, NspCells *B); 
extern NspCells *nsp_cells_extract_obsolete(NspCells *A, NspMatrix *Rows, NspMatrix *Cols); 
extern NspCells *nsp_cells_extract_elements_obsolete(NspCells *A, NspMatrix *Elts, int *err); 
extern NspCells *nsp_cells_extract_columns_obsolete(NspCells *A, NspMatrix *Cols, int *err); 
