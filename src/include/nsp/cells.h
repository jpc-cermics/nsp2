...
extern int nsp_cells_info(const NspCells *Mat, int indent,char *name, int rec_level); 
extern int nsp_cells_print(const NspCells *Mat, int indent,char *name, int rec_level); 
...
extern NspCells *nsp_cells_m2ce_full(NspMatrix *M);
...
static char *nsp_cells_type_as_string(void);
static char *nsp_cells_type_short_string(NspObject *v);
static NspObject *nsp_cells_loop_extract(char *str, NspObject *O, NspObject *O1, int i, int *rep);
static int nsp_cells_eq(NspObject *A,NspObject *B);
static int nsp_cells_neq(NspObject *A,NspObject *B);
static int nsp_cells_is_true(NspCells *M);
static NspCells *nsp_cells_xdr_load(XDR  *F);
