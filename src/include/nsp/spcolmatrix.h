...
extern int nsp_spcolmatrix_latex_print(NspSpColMatrix *Sp, int use_math,char *name, int rec_level);
...
extern NspSpColMatrix *nsp_spcolmatrix_redim(NspSpColMatrix *A, int m, int n, Boolean inplace); 
 ...
 extern int nsp_spcolmatrix_set_diag(NspSpColMatrix *A, NspObject *ODiag, int k); 
