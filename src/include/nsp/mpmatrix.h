...
extern int nsp_mpmatrix_set_submatrix_obsolete(NspMaxpMatrix *A, NspMatrix *Rows, NspMatrix *Cols, NspMaxpMatrix *B); 
extern int nsp_mpmatrix_set_rows_obsolete(NspMaxpMatrix *A, NspMatrix *Rows, NspMaxpMatrix *B); 
extern NspMaxpMatrix *nsp_mpmatrix_extract_obsolete(const NspMaxpMatrix *A,const  NspMatrix *Rows,const  NspMatrix *Cols); 
extern NspMaxpMatrix *nsp_mpmatrix_extract_elements_obsolete(const NspMaxpMatrix *A,const  NspMatrix *Elts); 
extern NspMaxpMatrix *nsp_mpmatrix_extract_columns_obsolete(const NspMaxpMatrix *A,const  NspMatrix *Cols); 
extern NspMaxpMatrix *nsp_mpmatrix_extract_rows_obsolete(const NspMaxpMatrix *A,const  NspMatrix *Rows); 
