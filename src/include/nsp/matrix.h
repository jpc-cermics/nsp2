...
extern NspObject *nsp_alloc_mat_or_imat(int m, int n, char ind_type, int **index);
...
extern int nsp_matrix_latex_print(NspMatrix *Mat, int indent,const char *name, int rec_level);
extern int nsp_matrix_latex_tab_print(NspMatrix *Mat, int indent,const char *name, int rec_level);
...
/* from MatOps.c */
extern int nsp_mat_scale_rows(NspMatrix *A, NspMatrix *x, char op);
extern int nsp_mat_scale_cols(NspMatrix *A, NspMatrix *x, char op);
...
extern int nsp_mat_fullcomp(NspMatrix *A, NspMatrix *B, char *op, int *err); 
extern int nsp_mat_find(NspMatrix *A, int lhs, NspObject **Res1, NspObject **Res2, char ind_type); 

extern int nsp_mat_mfind(const NspMatrix *x, int m,const char **ops,const double *scalars, NspObject **Ind, char ind_type);
extern int nsp_mat_ndind2ind(int *dims, int nd, NspMatrix **ndind, NspObject **Ind, char ind_type);
extern int nsp_mat_sub2ind(int *dims, int nd, NspMatrix **ndind, int nb_ind, NspObject **Ind, char ind_type);
extern int nsp_mat_ind2sub(int *dims, int nd, NspObject **ndind, NspObject *Obj, char ind_type);
...
extern int nsp_mat_unique_rows(NspMatrix *x, NspObject **Ind, NspMatrix **Occ, char ind_type);
extern int nsp_mat_unique_columns(NspMatrix *x, NspObject **Ind, NspMatrix **Occ, char ind_type);
...
/* misc */
extern NspObject *nsp_matrix_convert(const NspMatrix *A,const NspObject *B,void *args);
