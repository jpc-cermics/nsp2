...
extern int nsp_matrix_set_submatrix_obsolete(NspMatrix *A, NspMatrix *Rows, NspMatrix *Cols, NspMatrix *B); 
...
extern int nsp_matrix_set_rows_obsolete(NspMatrix *A, NspMatrix *Rows, NspMatrix *B); 
extern int mat_is_increasing (const NspMatrix *A); 
extern NspMatrix *nsp_matrix_extract_obsolete(const NspMatrix *A,const  NspMatrix *Rows,const  NspMatrix *Cols); 
extern NspMatrix *nsp_matrix_extract_elements_obsolete(const NspMatrix *A,const  NspMatrix *Elts); 
extern NspMatrix *nsp_matrix_extract_columns_obsolete(const NspMatrix *A,const  NspMatrix *Cols); 
extern NspMatrix *nsp_matrix_extract_rows_obsolete(const NspMatrix *A,const  NspMatrix *Rows); 
