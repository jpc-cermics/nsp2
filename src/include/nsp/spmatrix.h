...
extern NspSpMatrix   *nsp_spmatrix_object(NspObject *O);
 ...
 extern void nsp_spmatrix_row_destroy(SpRow *Row); 
...
/* SpMatOps.c */
 ...
 extern int nsp_spmatrix_clean(NspSpMatrix *A, int rhs, double epsa, double epsr); 
 extern NspMatrix *nsp_spmatrix_maximinitt_g(NspSpMatrix *A, NspSpMatrix *B, int flag, int minmaxflag, int *err); 
 extern NspMatrix *nsp_spmatrix_maxitt(NspSpMatrix *A, NspSpMatrix *B, int flag, int *err); 
 extern NspMatrix *nsp_spmatrix_minitt(NspSpMatrix *A, NspSpMatrix *B, int flag, int *err); 
 extern int nsp_spmatrix_realpart(NspSpMatrix *A); 
 extern int nsp_spmatrix_imagpart(NspSpMatrix *A); 
 extern NspSpMatrix *nsp_spmatrix_sum(NspSpMatrix *A, char *flag); 
 extern NspSpMatrix *nsp_spmatrix_maxi(NspSpMatrix *A, char *flag, NspMatrix **Imax, int lhs); 
 extern NspSpMatrix *nsp_spmatrix_eye(int m, int n); 
 extern NspSpMatrix *nsp_spmatrix_ones(int m, int n); 
 extern NspSpMatrix *nsp_spmatrix_zeros(int m, int n); 
 extern NspMatrix *nsp_spmatrix_acos(NspSpMatrix *A); 
 extern NspMatrix *nsp_spmatrix_acosh(NspSpMatrix *A); 
 extern void nsp_spmatrix_asin(NspSpMatrix *A); 
 extern void nsp_spmatrix_asinh(NspSpMatrix *A); 
 extern void nsp_spmatrix_atan(NspSpMatrix *A); 
 extern void nsp_spmatrix_atanh(NspSpMatrix *A); 
 extern void nsp_spmatrix_ceil(NspSpMatrix *A); 
 extern void nsp_spmatrix_int(NspSpMatrix *A); 
 extern void nsp_spmatrix_floor(NspSpMatrix *A); 
 extern void nsp_spmatrix_round(NspSpMatrix *A); 
 extern int nsp_spmatrix_sign(NspSpMatrix *A); 
 extern void nsp_spmatrix_tan(NspSpMatrix *A); 
 extern void nsp_spmatrix_tanh(NspSpMatrix *A); 
 extern int nsp_spmatrix_abs(NspSpMatrix *A); 
 extern int nsp_spmatrix_erf(NspSpMatrix *A); 
 extern int nsp_spmatrix_arg(NspSpMatrix *A); 
 extern void nsp_spmatrix_conj(NspSpMatrix *A); 
 extern NspMatrix *nsp_spmatrix_cos(NspSpMatrix *A); 
 extern NspMatrix *nsp_spmatrix_cosh(NspSpMatrix *A); 
 extern NspMatrix *nsp_spmatrix_expel(NspSpMatrix *A); 
extern int nsp_spmatrix_logel(NspSpMatrix *A); 
extern void nsp_spmatrix_sin(NspSpMatrix *A); 
extern void nsp_spmatrix_sinh(NspSpMatrix *A); 
extern int nsp_spmatrix_sqrtel(NspSpMatrix *A); 
extern int nsp_spmatrix_minus(NspSpMatrix *A); 
extern int nsp_spmatrix_find(NspSpMatrix *A, int lhs, NspMatrix **Res1, NspMatrix **Res2); 
