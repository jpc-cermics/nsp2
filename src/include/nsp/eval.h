...
extern int nsp_gtk_eval_function_catch(NspPList *func,NspObject *args[],int n_args,NspObject  *ret[],int *nret, int errcatch,int pausecatch);
extern int nsp_gtk_eval_function_by_name(const char *name,NspObject *args[],int n_args, NspObject  *ret[],int *nret);
extern int nsp_gtk_eval_function_by_name_catch(const char *name,NspObject *args[],int n_args, NspObject  *ret[],int *nret, int errcatch,int pausecatch);
