/* -*- Mode: C -*- */
#ifndef NSP_INC_NspAtkObject
#define NSP_INC_NspAtkObject
...
/* from NspAtkObjectObj.c */

extern NspAtkObject *nsp_atkobject_object (NspObject *O);
...
#endif /* NSP_INC_NspAtkObject */ 

#ifdef NspAtkObject_Private 
