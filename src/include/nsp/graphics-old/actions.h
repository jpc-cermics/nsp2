...
typedef void driver_gc_loadsg(BCG *Xgc,const char *filename);
...
typedef void driver_gc_savesg(BCG *Xgc,const char *filename);
...
extern Nsp_gc_actions nsp_gc_actions_old ;
...
Nsp_gc_actions nsp_gc_actions_old = {
  nsp_gc_change,
  nsp_gc_2dzoom,
  nsp_gc_3drot,
  nsp_gc_delete,
