...
#line 58 "codegen/block.override"
...
static int block_set_pos (NspBlock *R, const double pt[2]);
static void block_get_pos (NspBlock *R, double pt[2]);
static void block_resize (NspBlock *R, const double size[2]);
static void block_update_locks (NspBlock *R);
static int block_contains_pt (const NspBlock *B, const double pt[2]);
static int block_control_near_pt (const NspBlock *B, const double pt[2], int *cp);
static int block_lock_near_pt (const NspBlock *B, double pt[2], int *cp);
static void block_move_control_init( NspBlock *B,int cp,double ptc[2]);
static void block_move_control (void *F,NspBlock *B, const double pt[2], int cp,double ptc[2]);
