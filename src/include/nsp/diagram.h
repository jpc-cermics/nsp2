...
extern NspDiagram *GetDiagram (Stack stack, int i); 
extern int IsDiagram (NspObject *O); 
extern int nsp_diagram_select_obj (NspDiagram *R, const double pt[2], NspObject **Objs,NspObject *exclude); 
extern int nsp_diagram_select_lock(NspDiagram *F,double pt[2], NspObject **O, int *cp, int *lock_c) ;
extern int nsp_diagram_select_and_move (NspDiagram *R, const double pt[2], int mask); 
...
extern int nsp_diagram_move_obj (NspDiagram *R,NspObject *O, const double pt[2], int stop, int cp,move_action  action ); 
