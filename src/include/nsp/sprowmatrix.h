...
extern int nsp_sprowmatrix_info(NspSpRowMatrix *Sp, int indent,const char *name, int rec_level);
extern int nsp_sprowmatrix_print(NspSpRowMatrix *Sp, int indent,char *name, int rec_level); 
...
extern void SpRowRowDestroy (SpRow *Row); 
 ...
 extern int nsp_sprowmatrix_set_rowcol(NspSpRowMatrix *A, NspObject *Rows, NspObject *Cols, NspSpRowMatrix *B); 
 extern int nsp_sprowmatrix_set_row(NspSpRowMatrix *A, NspObject *Inds, NspSpRowMatrix *B); 
 extern int nsp_sprowmatrix_delete_cols(NspSpRowMatrix *A, NspObject *Cols); 
...
extern int nsp_sprowmatrix_compress_row_simple(NspSpRowMatrix *A, int i);
 extern int nsp_sprowmatrix_delete_rows(NspSpRowMatrix *A, NspObject *Rows); 
 extern NspSpRowMatrix *nsp_sprowmatrix_extract(NspSpRowMatrix *A, NspObject *Rows, NspObject *Cols); 
 extern NspSpRowMatrix *nsp_sprowmatrix_extract_elts(NspSpRowMatrix *A, NspObject *Elts); 
...
extern int nsp_sprowmatrix_isreal(const NspSpRowMatrix *A, int strict);
 extern NspSpRowMatrix *nsp_sprowmatrix_sum(NspSpRowMatrix *A, int dim); 
 extern NspSpRowMatrix *nsp_sprowmatrix_maxi(NspSpRowMatrix *A, int dim, NspMatrix **Imax, int lhs); 
extern NspSpRowMatrix *nsp_sprowmatrix_mini(NspSpRowMatrix *A, int dim, NspMatrix **Imax, int lhs);
 extern NspSpRowMatrix *nsp_sprowmatrix_eye(int m, int n); 
 extern NspSpRowMatrix *nsp_sprowmatrix_ones(int m, int n); 
 extern NspSpRowMatrix *nsp_sprowmatrix_zeros(int m, int n); 
