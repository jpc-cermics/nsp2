...
static int _wrap_gdk_window_focus(NspGdkWindow *self,Stack stack,int rhs,int opt,int lhs)
{
  ...
  nsp_option opts[] = {
	...
	{NULL,t_end,NULLOBJ,-1} };
  time_t timestamp = GDK_CURRENT_TIME;
