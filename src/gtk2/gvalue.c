...
#line 4 "codegen/gvalue.override"
 ...
 *-----------------------------------------------------*/
#line 25 "codegen/gvalue.override"
...
#line 75 "codegen/gvalue.override"
 ...
 * Methods
 *-------------------------------------------*/
#line 99 "codegen/gvalue.override"
...
#line 147 "codegen/gvalue.override"
...
static int nsp_fill_g_value_from_nspobject(GValue *value, NspObject *obj)
{
  if (IsMat(obj) && ((NspMatrix *) obj)->mn == 1 )
  ...
  else if ( IsBMat(obj) && ((NspBMatrix *) obj)->mn == 1)
    {
      ...
      g_value_set_boolean (value,((NspMatrix *) obj)->R[0] );
    }
