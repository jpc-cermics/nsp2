...
static AttrTab gmarkup_node_attrs[] = {
  { "op", (attr_get_function *)_wrap_gmarkup_node_get_op, (attr_set_function *)_wrap_gmarkup_node_set_op,(attr_get_object_function *)int_get_object_failed },
  { "arity", (attr_get_function *)_wrap_gmarkup_node_get_arity, (attr_set_function *)_wrap_gmarkup_node_set_arity,(attr_get_object_function *)int_get_object_failed },
  { "attributes", _wrap_gmarkup_node_get_attrs,
    _wrap_gmarkup_node_set_attrs, _wrap_gmarkup_node_get_object_attrs},
  { "children", _wrap_gmarkup_node_get_children,
    _wrap_gmarkup_node_set_children, _wrap_gmarkup_node_get_object_children},
