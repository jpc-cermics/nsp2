...
int int_scicos(Stack stack, int rhs, int opt, int lhs) 
{
  ...
  */
  ...
  /* 4e2  --   subvariable funptr(sim) -- */
  nblk =Sim_elts[0]->m;
  /* 4e3     --   subvariable xptr(sim) -- */
  /* 4e4     --   subvariable zptr(sim) -- */
  /* 4e5     --   subvariable zcptr (sim)  */
  /* 4e6     --   subvariable inpptr(sim) -- */
  ninpptr = Sim_elts[4]->m;
  /* 4e7    --   subvariable outptr(sim) -- */
  noutptr = Sim_elts[5]->m;
  /* 4e8    --   subvariable inplnk(sim) -- */
  ninplnk = Sim_elts[6]->m;
  /* 4e9    --   subvariable outlnk(sim) -- */
  noutlnk =Sim_elts[7] ->m;
  /* 4e10     --   subvariable lnkptr(sim) -- */
  nlnkptr = Sim_elts[8]->m;
  /* 4e11     --   subvariable rpar(sim) -- */
  nrpar = Sim_elts[9];
  /* 4e12       --   subvariable rpptr(sim) -- */
  /* 4e13      --   subvariable ipar(sim) -- */
  nipar = Sim_elts[11];
  /*  4e14     --   subvariable ipptr(sim) -- */
  /*  4e15     --   subvariable clkptr(sim) -- */
  /*  4e16     --   subvariable ordptr(sim) -- */
  /*       --   subvariable execlk(sim) -- */
  /*       --   subvariable ordclk(sim) -- */
  /*       --   subvariable cord(sim) -- */
  /*       --   subvariable oord(sim) -- */
  /*       --   subvariable zord(sim) -- */
  /*       --   subvariable critev(sim) -- */
  /* 4e23      --   subvariable nb(sim) -- */
  if ( Sim_elts[21]->R[0] !=  nblk )
    {
    }
  /* 4e24  --   subvariable ztyp(sim) -- */
  /*
  ...
  if(n4.ge.30) 
    {
      ...
      n4e30 = Sim_elts[28]->m*istk(il4e30+2);
      labptr=il4e30+4;
      llab=labptr+n4e30+1;
      nlab=istk(llab-1)-1;
      }
 ...
 */
  ...
  */
  ...
  if (Sim_elts[1]->m !=  Sim_elts[2]->m) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (Sim_elts[1]->m !=  Sim_elts[3]->m) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (Sim_elts[1]->m !=  Sim_elts[4]->m) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (Sim_elts[1]->m !=  Sim_elts[5]->m) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (Sim_elts[1]->m !=  Sim_elts[10]->m) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (Sim_elts[1]->m !=  Sim_elts[12]->m) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (Sim_elts[1]->m !=  Sim_elts[13]->m) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (mSim_elts[16]!= 2.and.n4e18!= 0) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (mSim_elts[17]!= 2.and.n4e19!= 0) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (mSim_elts[0]0!= 2.and.Sim_elts[18]->m!= 0) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (mSim_elts[0]1!= 2.and.Sim_elts[19]->m!= 0) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  if (mSim_elts[0]9!= 2.and.Sim_elts[27]->m!= 0) {
    Scierror("Sim: element has a wrong size\n");return RET_BUG;
  }
  call entier(Sim_elts[1]->m,stk(l4e3),istk(iadr(l4e3)));
  call entier(Sim_elts[2]->m,stk(l4e4),istk(iadr(l4e4)));
  call entier(Sim_elts[3]->m,stk(l4e5),istk(iadr(l4e5)));
  call entier(n1e6,stk(l1e6),istk(iadr(l1e6)));
  call entier(Sim_elts[4]->m,stk(l4e6),istk(iadr(l4e6)));
  call entier(Sim_elts[5]->m,stk(l4e7),istk(iadr(l4e7)));
  call entier(Sim_elts[6]->m,stk(l4e8),istk(iadr(l4e8)));
  call entier(Sim_elts[7]->m,stk(l4e9),istk(iadr(l4e9)));
  call entier(Sim_elts[8]->m,stk(l4e10),istk(iadr(l4e10)));
  call entier(Sim_elts[10]->m,stk(l4e12),istk(iadr(l4e12)));
  call entier(Sim_elts[11]->m,stk(l4e13),istk(iadr(l4e13)));
  call entier(Sim_elts[12]->m,stk(l4e14),istk(iadr(l4e14)));
  call entier(Sim_elts[13]->m,stk(l4e15),istk(iadr(l4e15)));
  call entier(Sim_elts[14]->m,stk(l4e16),istk(iadr(l4e16)));
  call entier(Sim_elts[1]->m1,stk(lSim_elts[29]),istk(iadr(l4e31)));
  call entier(Sim_elts[16]->m*m4e18,stk(l4e18),istk(iadr(l4e18)));
  call entier(Sim_elts[17]->m*m4e19,stk(l4e19),istk(iadr(l4e19)));
  call entier(Sim_elts[0]->m0*mSim_elts[18],stk(l4e20),istk(iadr(l4e20)));
  call entier(Sim_elts[0]->m1*mSim_elts[19],stk(l4e21),istk(iadr(l4e21)));
  call entier(Sim_elts[0]->m2,stk(lSim_elts[20]),istk(iadr(l4e22)));
  call entier(1,stk(lSim_elts[0]3),istk(iadr(lSim_elts[21])));
  call entier(Sim_elts[0]->m4,stk(lSim_elts[22]),istk(iadr(l4e24)));
  ...
  call entier(Sim_elts[0]->m7,stk(lSim_elts[25]),istk(iadr(l4e27)));
  call entier(Sim_elts[0]->m8,stk(lSim_elts[26]),istk(iadr(l4e28)));
  ilfuntyp=iadr(lSim_elts[0]8);
  call entier(Sim_elts[0]->m9*mSim_elts[27],stk(l4e29),istk(iadr(l4e29)));;
  /*
c
        if(m6.eq.4) then
...
c
     ...
     $       istk(iadr(lSim_elts[0]9)),Sim_elts[27]->m,
     $       istk(iadr(lSim_elts[0]0)),Sim_elts[18]->m,istk(iadr(lSim_elts[19])),n4e21,
     $       istk(iadr(lSim_elts[0]2)),nblk,istk(iadr(lSim_elts[22])),istk(iadr(lSim_elts[3])),
     $       istk(iadr(lSim_elts[0]7)),Sim_elts[25]->m,simpar,flag,ierr)
        idb=0
        if (ierr .gt. 0 ) then
           if(ierr.eq.1) then
