		...
		int *liw, ode_jac jac, int *jt, void *param)
{
   ...
   * 
   * 
   *This version has been modified by L. LOTH on 91 
   *      see Comments noted "cLOTH" 
   * 
   ...
   *              ! use as a pointer to datas for external written in C 
   ...
   * 
   *iv.  description of two subroutines in the lsoda package, either of 
   ...
   *             and is normally 500. => changed to 10000 (bruno))  to continue, the user may 
   ...
   * 
   *  call svcma (rsav, isav)   store in rsav and isav the contents 
   *                            of the internal common blocks used by 
   *                            lsoda (see part iii below). 
   *                            rsav must be a real array of length 241 
   *                            or more, and isave must be an int 
   *                            array of length 50 or more. 
   * 
   *  call rscma (rsav, isav)   restore, from rsav and isav, the contents 
   *                            of the internal common blocks used by 
   *                            lsoda.  presumes a prior call to svcma 
   *                            with the same arguments. 
   * 
   *                            svcma and rscma are useful if 
   ...
   *blocks, use subroutines svcma and rscma (see part ii above). 
   * 
   * 
   ...
   *          weighted max-norm on vectors. 
   * svcma and rscma   are user-callable routines to save and restore, 
   ...
   *    sandia national laboratories report sand80-8230, september 1980. 
   *! 
   *this is the may 7, 1982 version of lsoda. 
   * 
 ...
 L60:
  ...
  C2F (xerrwv) ("lsoda-- attention size of  rwork now suffisent", &c__60,
		&c__103, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42,
		46L);
  C2F (xerrwv) ("but may become too small : integration continues", &c__60,
		&c__103, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42,
		48L);
  C2F (xerrwv) ("required size is i1 given size is i2", &c__50, &c__103,
		&c__1, &c__2, &lenrw, lrw, &c__0, &c_b42, &c_b42, 36L);
 L65:
  ...
  lsa001_1.insufi = 2;
  C2F (xerrwv) ("lsoda-- size for  iwork now sufficient", &c__60, &c__104,
		&c__1, &c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42, 38L);
  C2F (xerrwv) ("may become too small.  integration continues", &c__60,
		&c__104, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42,
		44L);
  C2F (xerrwv) ("required size is i1, given size is i2", &c__50, &c__104,
		&c__1, &c__2, &leniw, liw, &c__0, &c_b42, &c_b42, 37L);
 L70:
 ...
 L280:
  ...
  /*    (change by bp): new behavior: we return istate = -8 when t=t+h occurs 
   */
  C2F (xerrwvb) ("lsoda:", &c__6, &c__1101, &c__1, &c__0, &c__0, &c__0,
  ...
  *istate = -8;
   ...
   *     call xerrwvb('lsoda:', 6,101,1,0,0,0,2,tn,h) 
   ...
   *     call xerrwvb('lsoda:', 6, 102, 1, 1, mxhnil, 0, 0, 0.0, 0.0) 
   *ou return 
   */
 L290:
  /*----------------------------------------------------------------------- 
 ...
 L300:
  ...
  if (ls0001_1.meth == 2)
    {
      C2F (xerrwv) ("lsoda-- using stiff method  ", &c__60, &c__105, &c__1,
		    &c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42, 28L);
    }
  if (ls0001_1.meth == 1)
    {
      C2F (xerrwv) ("lsoda-- using adams formulas (non stiff)", &c__60,
		    &c__106, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b42,
		    &c_b42, 40L);
    }
  C2F (xerrwv) ("     a t = r1, trial with step h = r2,  step nst = i1 ",
		&c__60, &c__107, &c__1, &c__1, &ls0001_1.nst, &c__0, &c__2,
		&ls0001_1.tn, &ls0001_1.h__, 54L);
 L310:
  switch (*itask)
    {
    case 1:
 ...
 L430:
  ...
  C2F (xerrwv)
    ("lsoda--  repeated calls with istate = 1 and tout = t (=r1)  ", &c__60,
     &c__301, &c__1, &c__0, &c__0, &c__0, &c__1, t, &c_b42, 60L);
  goto L800;
  /*----------------------------------------------------------------------- 
   *block h. 
   ...
   */
 L500:
  C2F (xerrwvb) ("lsoda:", &c__6, &c__201, &c__1, &c__1, &ls0001_1.mxstep,
 ...
 L510:
   ...
   */
  C2F (xerrwvb) ("lsoda:", &c__6, &c__202, &c__1, &c__1, &i__, &c__0, &c__2,
		 &ls0001_1.tn, &ewti, 6L);
  *istate = -6;
  goto L580;
   ...
   */
 L520:
  C2F (xerrwvb) ("lsoda:", &c__6, &c__203, &c__1, &c__0, &c__0, &c__0, &c__2,
  ...
  *istate = -2;
   ...
   */
 L530:
  C2F (xerrwv) ("lsoda--  at t(=r1) and for step h(=r2), error", &c__50,
		&c__204, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42,
		45L);
  C2F (xerrwv) ("      failed with Abs(h) = hmin", &c__50, &c__204, &c__1,
		&c__0, &c__0, &c__0, &c__2, &ls0001_1.tn, &ls0001_1.h__, 31L);
  *istate = -4;
  goto L560;
   ...
   */
 L540:
  C2F (xerrwvb) ("lsoda:", &c__6, &c__205, &c__1, &c__0, &c__0, &c__0, &c__2,
  ...
  *istate = -5;
   ...
   */
 L550:
  C2F (xerrwv) ("lsoda--  a t(=r1), rwork too small", &c__50, &c__206, &c__1,
		&c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42, 34L);
  C2F (xerrwv) ("        to continue. integration ok.", &c__60, &c__206,
		&c__1, &c__0, &c__0, &c__0, &c__1, &ls0001_1.tn, &c_b42, 36L);
  *istate = -7;
  goto L580;
  /*iwork length too small to proceed. ----------------------------------- 
   */
 L555:
  C2F (xerrwv) ("lsoda--  at t(=r1)  iwork too small", &c__50, &c__207, &c__1,
		&c__0, &c__0, &c__0, &c__0, &c_b42, &c_b42, 35L);
  C2F (xerrwv) ("       to continue.  integration ok.", &c__60, &c__207,
		&c__1, &c__0, &c__0, &c__0, &c__1, &ls0001_1.tn, &c_b42, 36L);
  *istate = -7;
  goto L580;
  ...
  *t = ls0001_1.tn;
   ...
   */
 L601:
  C2F (xerrwv) ("lsoda--  istate (=i1) illegal ", &c__30, &c__1, &c__1, &c__1,
		istate, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L602:
  C2F (xerrwv) ("lsoda--  itask (=i1) illegal  ", &c__30, &c__2, &c__1, &c__1,
		itask, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L603:
  C2F (xerrwv) ("lsoda--  istate .gt. 1 ", &c__50, &c__3, &c__1, &c__0, &c__0,
		&c__0, &c__0, &c_b42, &c_b42, 23L);
  goto L700;
 L604:
  C2F (xerrwv) ("lsoda--  neq (=i1) .lt. 1     ", &c__30, &c__4, &c__1, &c__1,
		&neq[1], &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L605:
  C2F (xerrwv) ("lsoda--  istate and neq  increased from i1 to i2", &c__50,
		&c__5, &c__1, &c__2, &ls0001_1.n, &neq[1], &c__0, &c_b42,
		&c_b42, 48L);
  goto L700;
 L606:
  C2F (xerrwv) ("lsoda--  itol (=i1) illegal   ", &c__30, &c__6, &c__1, &c__1,
		itol, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L607:
  C2F (xerrwv) ("lsoda--  iopt (=i1) illegal   ", &c__30, &c__7, &c__1, &c__1,
		iopt, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L608:
  C2F (xerrwv) ("lsoda--  jt (=i1) illegal     ", &c__30, &c__8, &c__1, &c__1,
		jt, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L609:
  C2F (xerrwv) ("lsoda--  ml (=i1) illegal.. .lt.0 or .ge.neq (=i2)", &c__50,
		&c__9, &c__1, &c__2, &ml, &neq[1], &c__0, &c_b42, &c_b42,
		50L);
  goto L700;
 L610:
  C2F (xerrwv) ("lsoda--  mu (=i1) illegal.. .lt.0 or .ge.neq (=i2)", &c__50,
		&c__10, &c__1, &c__2, &mu, &neq[1], &c__0, &c_b42, &c_b42,
		50L);
  goto L700;
 L611:
  C2F (xerrwv) ("lsoda--  ixpr (=i1) illegal   ", &c__30, &c__11, &c__1,
		&c__1, &lsa001_1.ixpr, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L612:
  C2F (xerrwv) ("lsoda--  mxstep (=i1) .lt. 0  ", &c__30, &c__12, &c__1,
		&c__1, &ls0001_1.mxstep, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L613:
  C2F (xerrwv) ("lsoda--  mxhnil (=i1) .lt. 0  ", &c__30, &c__13, &c__1,
		&c__1, &ls0001_1.mxhnil, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L614:
  C2F (xerrwv) ("lsoda--  tout (=r1)  .gt.  t (=r2)      ", &c__40, &c__14,
		&c__1, &c__0, &c__0, &c__0, &c__2, tout, t, 40L);
  C2F (xerrwv) ("      h0 (=r1) gives direction", &c__50, &c__14, &c__1,
		&c__0, &c__0, &c__0, &c__1, &h0, &c_b42, 30L);
  goto L700;
 L615:
  C2F (xerrwv) ("lsoda--  hmax (=r1) .lt. 0.0  ", &c__30, &c__15, &c__1,
		&c__0, &c__0, &c__0, &c__1, &hmax, &c_b42, 30L);
  goto L700;
 L616:
  C2F (xerrwv) ("lsoda--  hmin (=r1) .lt. 0.0  ", &c__30, &c__16, &c__1,
		&c__0, &c__0, &c__0, &c__1, &ls0001_1.hmin, &c_b42, 30L);
  goto L700;
 L617:
  C2F (xerrwv) ("lsoda-- required size for iwork (i1) larger than i2", &c__60,
		&c__17, &c__1, &c__2, &lenrw, lrw, &c__0, &c_b42, &c_b42,
		51L);
  goto L700;
 L618:
  C2F (xerrwv) ("lsoda-- required size for iwork (=i1) larger than i2",
		&c__60, &c__18, &c__1, &c__2, &leniw, liw, &c__0, &c_b42,
		&c_b42, 52L);
  goto L700;
 L619:
  C2F (xerrwv) ("lsoda--  rtol(i1) is r1 .lt. 0.0        ", &c__40, &c__19,
		&c__1, &c__1, &i__, &c__0, &c__1, &rtoli, &c_b42, 40L);
  goto L700;
 L620:
  C2F (xerrwv) ("lsoda--  atol(i1) is r1 .lt. 0.0        ", &c__40, &c__20,
		&c__1, &c__1, &i__, &c__0, &c__1, &atoli, &c_b42, 40L);
  goto L700;
 L621:
  ewti = rwork[ls0001_1.lewt + i__ - 1];
  C2F (xerrwv) ("lsoda--  ewt(i1) is r1 .le. 0.0         ", &c__40, &c__21,
		&c__1, &c__1, &i__, &c__0, &c__1, &ewti, &c_b42, 40L);
  goto L700;
 L622:
  C2F (xerrwv) ("lsoda--  tout (=r1) too close to t(=r2) to integrate",
		&c__60, &c__22, &c__1, &c__0, &c__0, &c__0, &c__2, tout, t,
		52L);
  goto L700;
 L623:
  C2F (xerrwv) ("lsoda--  itask = i1 and tout (=r1) .gt. tcur - hu (= r2)  ",
		&c__60, &c__23, &c__1, &c__1, itask, &c__0, &c__2, tout, &tp,
		58L);
  goto L700;
 L624:
  C2F (xerrwv) ("lsoda--  itask = 4 or 5 and tcrit (=r1) .gt. tcur (=r2)   ",
		&c__60, &c__24, &c__1, &c__0, &c__0, &c__0, &c__2, &tcrit,
		&ls0001_1.tn, 58L);
  goto L700;
 L625:
  C2F (xerrwv) ("lsoda--  itask = 4 or 5 and tcrit (=r1)  .lt.  tout (=r2)",
		&c__60, &c__25, &c__1, &c__0, &c__0, &c__0, &c__2, &tcrit,
		tout, 57L);
  goto L700;
 L626:
  C2F (xerrwv) ("lsoda-- precision asked ", &c__50, &c__26, &c__1, &c__0,
		&c__0, &c__0, &c__0, &c_b42, &c_b42, 24L);
  C2F (xerrwv) ("too accurate. tolsf (=r1)", &c__60, &c__26, &c__1, &c__0,
		&c__0, &c__0, &c__1, &tolsf, &c_b42, 25L);
  rwork[14] = tolsf;
  goto L700;
 L627:
  C2F (xerrwv) ("lsoda--  problems due to intdy. itask=i1,tout=r1", &c__50,
		&c__27, &c__1, &c__1, itask, &c__0, &c__1, tout, &c_b42, 48L);
  goto L700;
 L628:
  C2F (xerrwv) ("lsoda--  mxordn (=i1) .lt. 0  ", &c__30, &c__28, &c__1,
		&c__1, &lsa001_1.mxordn, &c__0, &c__0, &c_b42, &c_b42, 30L);
  goto L700;
 L629:
  C2F (xerrwv) ("lsoda--  mxords (=i1) .lt. 0  ", &c__30, &c__29, &c__1,
		&c__1, &lsa001_1.mxords, &c__0, &c__0, &c_b42, &c_b42, 30L);
  /* 
   */
 L700:
  if (ls0001_1.illin == 5)
  ...
  *istate = -3;
  return 0;
 L710:
  C2F (xerrwv) ("lsoda--  incorrect input", &c__50, &c__302, &c__1, &c__0,
		&c__0, &c__0, &c__0, &c_b42, &c_b42, 24L);
  /* 
   */
 L800:
  C2F (xerrwv) ("lsoda-- infinite loop? ", &c__50, &c__303, &c__2, &c__0,
		&c__0, &c__0, &c__0, &c_b42, &c_b42, 23L);
  return 0;
