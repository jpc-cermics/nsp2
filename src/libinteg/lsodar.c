...
int
nsp_ode_lsodar (ode_f f, int *neq, double *y, double *t, double *tout,
		   ...
		   int *jroot, double *param)
{
 ...
 L62:
  ...
  C2F (xerrwv)
    ("      may not be later.  integration will proceed anyway.   ", &c__60,
     &c__103, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b46, &c_b46, 60L);
  C2F (xerrwv) ("      length needed is lenrw = i1, while lrw = i2.",
		&c__50, &c__103, &c__1, &c__2, &lenrw, lrw, &c__0,
		&c_b46, &c_b46, 50L);
 L65:
  ...
  C2F (xerrwv)
    ("      may not be later.  integration will proceed anyway.   ", &c__60,
     &c__104, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b46, &c_b46, 60L);
  C2F (xerrwv) ("      length needed is leniw = i1, while liw = i2.",
		&c__50, &c__104, &c__1, &c__2, &leniw, liw, &c__0,
		&c_b46, &c_b46, 50L);
 L70:
 ...
 L180:
  ...
  nsp_ode_rchek (&c__1, g, &neq[1], &y[1], &rwork[ls0001_1.lyh],
		    &ls0001_1.nyh, &rwork[lsr001_1.lg0], &rwork[lsr001_1.lg1],
		    &rwork[lsr001_1.lgx], &jroot[1], &irt, param);
  if (ierode_1.iero > 0)
    {
      return 0;
    }
 ...
 L200:
  ...
  nsp_ode_rchek (&c__2,  g, &neq[1], &y[1], &rwork[ls0001_1.lyh],
		    &ls0001_1.nyh, &rwork[lsr001_1.lg0], &rwork[lsr001_1.lg1],
		    &rwork[lsr001_1.lgx], &jroot[1], &irt, param);
  if (ierode_1.iero > 0)
    {
 ...
 L280:
  ...
  C2F (xerrwv) ("lsodar-  warning..internal t (=r1) and h (=r2) are",
		&c__50, &c__101, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  C2F (xerrwv)
    ("      such that in the machine, t + h = t on the next step ", &c__60,
     &c__101, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b46, &c_b46, 59L);
  C2F (xerrwv) ("      (h = step size). solver will continue anyway",
		&c__50, &c__101, &c__1, &c__0, &c__0, &c__0, &c__2,
		&ls0001_1.tn, &ls0001_1.h__, 50L);
  if (ls0001_1.nhnil < ls0001_1.mxhnil)
    {
      goto L290;
    }
  C2F (xerrwv) ("sodar-  above warning has been issued i1 times.  ",
		&c__50, &c__102, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 49L);
  C2F (xerrwv) ("     it will not be issued again for this problem",
		&c__50, &c__102, &c__1, &c__1, &ls0001_1.mxhnil, &c__0,
		&c__0, &c_b46, &c_b46, 49L);
 L290:
  /*----------------------------------------------------------------------- 
 ...
 L310:
  ...
  nsp_ode_rchek (&c__3, g, &neq[1], &y[1], &rwork[ls0001_1.lyh],
		    &ls0001_1.nyh, &rwork[lsr001_1.lg0], &rwork[lsr001_1.lg1],
		    &rwork[lsr001_1.lgx], &jroot[1], &irt, param);
  if (ierode_1.iero > 0)
    {
 ...
 L430:
   ...
   */
 L500:
  C2F (xerrwv) ("lsodar-  at current t (=r1), mxstep (=i1) steps",
		&c__50, &c__201, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 47L);
  C2F (xerrwv) ("      taken on this call before reaching tout     ",
		&c__50, &c__201, &c__1, &c__1, &ls0001_1.mxstep, &c__0,
		&c__1, &ls0001_1.tn, &c_b46, 50L);
  *istate = -1;
  goto L580;
 ...
 L510:
  ...
  C2F (xerrwv) ("lsodar-  at t (=r1), ewt(i1) has become r2 .le. 0.",
		&c__50, &c__202, &c__1, &c__1, &i__, &c__0, &c__2,
		&ls0001_1.tn, &ewti, 50L);
  *istate = -6;
  goto L580;
  /*too much accuracy requested for machine precision. ------------------- 
   */
 L520:
  C2F (xerrwv) ("lsodar-  at t (=r1), too much accuracy requested ",
		&c__50, &c__203, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 49L);
  C2F (xerrwv) ("      for precision of machine..  see tolsf (=r2)",
		&c__50, &c__203, &c__1, &c__0, &c__0, &c__0, &c__2,
		&ls0001_1.tn, &tolsf, 49L);
  rwork[14] = tolsf;
  *istate = -2;
  goto L580;
   ...
   */
 L530:
  C2F (xerrwv) ("lsodar-  at t(=r1) and step size h(=r2), the error",
		&c__50, &c__204, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  C2F (xerrwv) ("      test failed repeatedly or with Abs(h) = hmin",
		&c__50, &c__204, &c__1, &c__0, &c__0, &c__0, &c__2,
		&ls0001_1.tn, &ls0001_1.h__, 50L);
  *istate = -4;
  goto L560;
   ...
   */
 L540:
  C2F (xerrwv) ("lsodar-  at t (=r1) and step size h (=r2), the   ",
		&c__50, &c__205, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 49L);
  C2F (xerrwv) ("      corrector convergence failed repeatedly    ",
		&c__50, &c__205, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 49L);
  ...
  *istate = -5;
   ...
   */
 L550:
  C2F (xerrwv) ("lsodar-  at current t(=r1), rwork length too small",
  ...
  *istate = -7;
   ...
   */
 L555:
  C2F (xerrwv) ("lsodar-  at current t(=r1), iwork length too small",
		&c__50, &c__207, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  C2F (xerrwv)
    ("      to proceed.  the integration was otherwise successful.", &c__60,
  ...
  *t = ls0001_1.tn;
   ...
   */
 L601:
  C2F (xerrwv) ("lsodar-  istate (=i1) illegal ", &c__30, &c__1, &c__1,
		&c__1, istate, &c__0, &c__0, &c_b46, &c_b46, 30L);
  goto L700;
 L602:
  C2F (xerrwv) ("lsodar-  itask (=i1) illegal  ", &c__30, &c__2, &c__1,
		&c__1, itask, &c__0, &c__0, &c_b46, &c_b46, 30L);
  goto L700;
 L603:
  C2F (xerrwv) ("lsodar-  istate .gt. 1 but lsodar not initialized ",
		&c__50, &c__3, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b46,
		&c_b46, 50L);
  goto L700;
 L604:
  C2F (xerrwv) ("lsodar-  neq (=i1) .lt. 1     ", &c__30, &c__4, &c__1,
		&c__1, &neq[1], &c__0, &c__0, &c_b46, &c_b46, 30L);
  goto L700;
 L605:
  C2F (xerrwv) ("lsodar-  istate = 3 and neq increased (i1 to i2)  ",
		&c__50, &c__5, &c__1, &c__2, &ls0001_1.n, &neq[1], &c__0,
		&c_b46, &c_b46, 50L);
  goto L700;
 L606:
  C2F (xerrwv) ("lsodar-  itol (=i1) illegal   ", &c__30, &c__6, &c__1,
		&c__1, itol, &c__0, &c__0, &c_b46, &c_b46, 30L);
  goto L700;
 L607:
  C2F (xerrwv) ("lsodar-  iopt (=i1) illegal   ", &c__30, &c__7, &c__1,
		&c__1, iopt, &c__0, &c__0, &c_b46, &c_b46, 30L);
  goto L700;
 L608:
  C2F (xerrwv) ("lsodar-  jt (=i1) illegal     ", &c__30, &c__8, &c__1,
		&c__1, jt, &c__0, &c__0, &c_b46, &c_b46, 30L);
  goto L700;
 L609:
  C2F (xerrwv) ("lsodar-  ml (=i1) illegal.. .lt.0 or .ge.neq (=i2)",
		&c__50, &c__9, &c__1, &c__2, &ml, &neq[1], &c__0, &c_b46,
		&c_b46, 50L);
  goto L700;
 L610:
  C2F (xerrwv) ("lsodar-  mu (=i1) illegal.. .lt.0 or .ge.neq (=i2)",
 ...
 L613:
  ...
  goto L700;
 L614:
  C2F (xerrwv) ("lsodar-  tout (=r1) behind t (=r2)      ", &c__40,
		&c__14, &c__1, &c__0, &c__0, &c__0, &c__2, tout, t, 40L);
  C2F (xerrwv) ("      integration direction is given by h0 (=r1)  ",
		&c__50, &c__14, &c__1, &c__0, &c__0, &c__0, &c__1, &h0,
		&c_b46, 50L);
  goto L700;
 L615:
 ...
 L618:
  ...
  goto L700;
 L619:
  C2F (xerrwv) ("lsodar-  rtol(i1) is r1 .lt. 0.0        ", &c__40,
		&c__19, &c__1, &c__1, &i__, &c__0, &c__1, &rtoli, &c_b46,
		40L);
  goto L700;
 L620:
  C2F (xerrwv) ("lsodar-  atol(i1) is r1 .lt. 0.0        ", &c__40,
		&c__20, &c__1, &c__1, &i__, &c__0, &c__1, &atoli, &c_b46,
		40L);
  goto L700;
 L621:
  ewti = rwork[ls0001_1.lewt + i__ - 1];
  C2F (xerrwv) ("lsodar-  ewt(i1) is r1 .le. 0.0         ", &c__40,
		&c__21, &c__1, &c__1, &i__, &c__0, &c__1, &ewti, &c_b46, 40L);
  goto L700;
 L622:
  C2F (xerrwv)
 ...
 L625:
  ...
  goto L700;
 L626:
  C2F (xerrwv) ("lsodar-  at start of problem, too much accuracy   ",
		&c__50, &c__26, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  C2F (xerrwv)
  ...
  goto L700;
 L627:
  C2F (xerrwv) ("lsodar-  trouble from intdy. itask = i1, tout = r1",
 ...
 L630:
  ...
  goto L700;
 L631:
  C2F (xerrwv) ("lsodar-  ng changed (from i1 to i2) illegally,    ",
		&c__50, &c__31, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  C2F (xerrwv) ("      i.e. not immediately after a root was found ",
		&c__50, &c__31, &c__1, &c__2, &lsr001_1.ngc, ng, &c__0,
		&c_b46, &c_b46, 50L);
  goto L700;
 L632:
  C2F (xerrwv) ("lsodar-  one or more components of g has a root   ",
		&c__50, &c__32, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  C2F (xerrwv) ("      too near to the initial point     ", &c__40,
		&c__32, &c__1, &c__0, &c__0, &c__0, &c__0, &c_b46,
		&c_b46, 40L);
  /* 
   */
 L700:
  ...
  *istate = -3;
  return 0;
 L710:
  C2F (xerrwv) ("lsodar-  repeated occurrences of illegal input    ",
		&c__50, &c__302, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  /* 
   */
 L800:
  C2F (xerrwv) ("lsodar-  run aborted.. apparent infinite loop     ",
		&c__50, &c__303, &c__2, &c__0, &c__0, &c__0, &c__0,
		&c_b46, &c_b46, 50L);
  return 0;
