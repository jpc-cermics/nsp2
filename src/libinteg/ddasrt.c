...
static int c__32 = 32;
static int c__46 = 46;
static int c__801 = 801;
static int c__802 = 802;
static double c_b588 = 1.;

int
nsp_ode_ddasrt (dassl_res res, int *neq, double *t, double *y, double *yprime,
		   double *tout, int *info, double *rtol, double *atol,
		   int *idid, double *rwork, int *lrw, int *iwork, int *liw,
		   double *rpar, int *ipar, dassl_jac jac, dassl_g g, int *ng,
		   int *jroot)
{
   ...
   *     EXTERNAL RES, JAC, G 
   *     INT NEQ, INFO(N), IDID, LRW, LIW, IWORK(LIW), IPAR, NG, 
   *    *   JROOT(NG) 
   ...
   *           code did.  You must monitor this int variable to decide 
   ...
   *     for G. 
   * 
   * JROOT  This is an int array of length NG for output 
   *        of root information. 
   * 
   * 
   **Description 
   ...
   * 
   *JROOT -- This is an int array of length NG.  It is used only for 
 ...
 L100:
   ...
   *    IS A FATAL ERROR. 
   */
  s_copy (msg, "DASSL--  THE LAST STEP TERMINATED WITH A NEGATIVE", 80L, 49L);
  C2F (xerrwv) (msg, &c__49, &c__201, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  s_copy (msg, "DASSL--  VALUE (=I1) OF IDID AND NO APPROPRIATE", 80L, 47L);
  C2F (xerrwv) (msg, &c__47, &c__202, &c__0, &c__1, idid, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  s_copy (msg, "DASSL--  ACTION WAS TAKEN. RUN TERMINATED", 80L, 41L);
  C2F (xerrwv) (msg, &c__41, &c__203, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  return 0;
 L110:
  iwork[10] = iwork[11];
 ...
 L340:
  ...
  nsp_ode_ddaini (&tn, &y[1], &yprime[1], neq, res, jac, &ho,
		     ...
		     &rwork[51], &rwork[le], &rwork[lwm], &iwork[1], &hmin,
 ...
 L350:
  ...
  nsp_ode_drchek (&c__1, g, ng, neq, t, tout, &y[1], &rwork[le],
		     &rwork[lphi], &rwork[29], &iwork[8], &rwork[lg0],
		     &rwork[lg1], &rwork[lgx], jroot, &irt, &rwork[9],
  ...
  nsp_ode_drchek (&c__3, g, ng, neq, &tn, tout, &y[1], &rwork[le],
		     &rwork[lphi], &rwork[29], &iwork[8], &rwork[lg0],
		     &rwork[lg1], &rwork[lgx], jroot, &irt, &rwork[9],
		     &info[3], &rwork[1], &iwork[1], &rpar[1], &ipar[1]);
  if (ierode_1.iero > 0)
  ...
  *t = rwork[41];
   ...
   */
  C2F (dcopy) (neq, &rwork[le], &c__1, &yprime[1], &c__1);
  goto L580;
  /* 
   */
 L390:
 ...
 L400:
   ...
   * 
   */
  nsp_ode_drchek (&c__2, g, ng, neq, &tn, tout, &y[1], &rwork[le],
		     &rwork[lphi], &rwork[29], &iwork[8], &rwork[lg0],
		     &rwork[lg1], &rwork[lgx], jroot, &irt, &rwork[9],
		     &info[3], &rwork[1], &iwork[1], &rpar[1], &ipar[1]);
  if (ierode_1.iero > 0)
 ...
 L526:
  ...
  nsp_ode_ddastp (&tn, &y[1], &yprime[1], neq,  res,  jac,
		     ...
		     &rwork[lphi], &rwork[51], &rwork[le], &rwork[lwm],
 ...
 L600:
   ...
   */
 L610:
  s_copy (msg, "DASSL--  AT CURRENT T (=R1)  500 STEPS", 80L, 38L);
  C2F (xerrwv) (msg, &c__38, &c__610, &c__0, &c__0, &c__0, &c__0, &c__1,
		&tn, &c_b30, 80L);
  s_copy (msg, "DASSL--  TAKEN ON THIS CALL BEFORE REACHING TOUT", 80L, 48L);
  C2F (xerrwv) (msg, &c__48, &c__611, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
   ...
   */
 L620:
  s_copy (msg, "DASSL--  AT T (=R1) TOO MUCH ACCURACY REQUESTED", 80L, 47L);
  C2F (xerrwv) (msg, &c__47, &c__620, &c__0, &c__0, &c__0, &c__0, &c__1,
		&tn, &c_b30, 80L);
  s_copy (msg, "DASSL--  FOR PRECISION OF MACHINE. RTOL AND ATOL", 80L, 48L);
  C2F (xerrwv) (msg, &c__48, &c__621, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  s_copy (msg, "DASSL--  WERE INCREASED TO APPROPRIATE VALUES", 80L, 45L);
  C2F (xerrwv) (msg, &c__45, &c__622, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  /* 
   */
  goto L690;
   ...
   */
 L630:
  s_copy (msg, "DASSL--  AT T (=R1) SOME ELEMENT OF WT", 80L, 38L);
  C2F (xerrwv) (msg, &c__38, &c__630, &c__0, &c__0, &c__0, &c__0, &c__1,
		&tn, &c_b30, 80L);
  s_copy (msg, "DASSL--  HAS BECOME .LE. 0.0", 80L, 28L);
  C2F (xerrwv) (msg, &c__28, &c__631, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
   ...
   */
 L640:
  s_copy (msg, "DASSL--  AT T (=R1) AND STEPSIZE H (=R2) THE", 80L, 44L);
  C2F (xerrwv) (msg, &c__44, &c__640, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tn, &h__, 80L);
  s_copy (msg, "DASSL--  ERROR TEST FAILED REPEATEDLY OR WITH ABS(H)=HMIN",
	  80L, 57L);
  C2F (xerrwv) (msg, &c__57, &c__641, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
 ...
 L650:
  s_copy (msg, "DASSL--  AT T (=R1) AND STEPSIZE H (=R2) THE", 80L, 44L);
  C2F (xerrwv) (msg, &c__44, &c__650, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tn, &h__, 80L);
  s_copy (msg, "DASSL--  CORRECTOR FAILED TO CONVERGE REPEATEDLY", 80L, 48L);
  C2F (xerrwv) (msg, &c__48, &c__651, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  s_copy (msg, "DASSL--  OR WITH ABS(H)=HMIN", 80L, 28L);
  C2F (xerrwv) (msg, &c__28, &c__652, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
 ...
 L660:
  s_copy (msg, "DASSL--  AT T (=R1) AND STEPSIZE H (=R2) THE", 80L, 44L);
  C2F (xerrwv) (msg, &c__44, &c__660, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tn, &h__, 80L);
  s_copy (msg, "DASSL--  ITERATION MATRIX IS SINGULAR", 80L, 37L);
  C2F (xerrwv) (msg, &c__37, &c__661, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
 ...
 L670:
  s_copy (msg, "DASSL--  AT T (=R1) AND STEPSIZE H (=R2) THE", 80L, 44L);
  C2F (xerrwv) (msg, &c__44, &c__670, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tn, &h__, 80L);
  s_copy (msg, "DASSL--  CORRECTOR COULD NOT CONVERGE.  ALSO, THE", 80L, 49L);
  C2F (xerrwv) (msg, &c__49, &c__671, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  s_copy (msg, "DASSL--  ERROR TEST FAILED REPEATEDLY.", 80L, 38L);
  C2F (xerrwv) (msg, &c__38, &c__672, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
 ...
 L675:
  s_copy (msg, "DASSL--  AT T (=R1) AND STEPSIZE H (=R2) THE", 80L, 44L);
  C2F (xerrwv) (msg, &c__44, &c__675, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tn, &h__, 80L);
  s_copy (msg, "DASSL--  CORRECTOR COULD NOT CONVERGE BECAUSE", 80L, 45L);
  C2F (xerrwv) (msg, &c__45, &c__676, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  s_copy (msg, "DASSL--  IRES WAS EQUAL TO MINUS ONE", 80L, 36L);
  C2F (xerrwv) (msg, &c__36, &c__677, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
   ...
   */
 L680:
  s_copy (msg, "DASSL--  AT T (=R1) AND STEPSIZE H (=R2)", 80L, 40L);
  C2F (xerrwv) (msg, &c__40, &c__680, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tn, &h__, 80L);
  s_copy (msg, "DASSL--  IRES WAS EQUAL TO MINUS TWO", 80L, 36L);
  C2F (xerrwv) (msg, &c__36, &c__681, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
  /* 
 ...
 L685:
  s_copy (msg, "DASSL--  AT T (=R1) AND STEPSIZE H (=R2) THE", 80L, 44L);
  C2F (xerrwv) (msg, &c__44, &c__685, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tn, &ho, 80L);
  s_copy (msg, "DASSL--  INITIAL YPRIME COULD NOT BE COMPUTED", 80L, 45L);
  C2F (xerrwv) (msg, &c__45, &c__686, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L690;
 L690:
  info[1] = -1;
  *t = tn;
   ...
   */
 L701:
  s_copy (msg, "DASSL--  SOME ELEMENT OF INFO VECTOR IS NOT ZERO OR ONE", 80L,
	  55L);
  C2F (xerrwv) (msg, &c__55, &c__1, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L702:
  s_copy (msg, "DASSL--  NEQ (=I1) .LE. 0", 80L, 25L);
  C2F (xerrwv) (msg, &c__25, &c__2, &c__0, &c__1, neq, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L703:
  s_copy (msg, "DASSL--  MAXORD (=I1) NOT IN RANGE", 80L, 34L);
  C2F (xerrwv) (msg, &c__34, &c__3, &c__0, &c__1, &mxord, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L704:
  s_copy (msg, "DASSL--  RWORK LENGTH NEEDED, LENRW (=I1), EXCEEDS LRW (=I2)",
	  80L, 60L);
  C2F (xerrwv) (msg, &c__60, &c__4, &c__0, &c__2, &lenrw, lrw, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L705:
  s_copy (msg, "DASSL--  IWORK LENGTH NEEDED, LENIW (=I1), EXCEEDS LIW (=I2)",
	  80L, 60L);
  C2F (xerrwv) (msg, &c__60, &c__5, &c__0, &c__2, &leniw, liw, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L706:
  s_copy (msg, "DASSL--  SOME ELEMENT OF RTOL IS .LT. 0", 80L, 39L);
  C2F (xerrwv) (msg, &c__39, &c__6, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L707:
  s_copy (msg, "DASSL--  SOME ELEMENT OF ATOL IS .LT. 0", 80L, 39L);
  C2F (xerrwv) (msg, &c__39, &c__7, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L708:
  s_copy (msg, "DASSL--  ALL ELEMENTS OF RTOL AND ATOL ARE ZERO", 80L, 47L);
  C2F (xerrwv) (msg, &c__47, &c__8, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L709:
  s_copy (msg, "DASSL--  INFO(4) = 1 AND TSTOP (=R1) BEHIND TOUT (=R2)", 80L,
	  54L);
  C2F (xerrwv) (msg, &c__54, &c__9, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tstop, tout, 80L);
  goto L750;
 L710:
  s_copy (msg, "DASSL--  HMAX (=R1) .LT. 0.0", 80L, 28L);
  C2F (xerrwv) (msg, &c__28, &c__10, &c__0, &c__0, &c__0, &c__0, &c__1,
		&hmax, &c_b30, 80L);
  goto L750;
 L711:
  s_copy (msg, "DASSL--  TOUT (=R1) BEHIND T (=R2)", 80L, 34L);
  C2F (xerrwv) (msg, &c__34, &c__11, &c__0, &c__0, &c__0, &c__0, &c__2,
		tout, t, 80L);
  goto L750;
 L712:
  s_copy (msg, "DASSL--  INFO(8)=1 AND H0=0.0", 80L, 29L);
  C2F (xerrwv) (msg, &c__29, &c__12, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L713:
  s_copy (msg, "DASSL--  SOME ELEMENT OF WT IS .LE. 0.0", 80L, 39L);
  C2F (xerrwv) (msg, &c__39, &c__13, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L714:
  s_copy (msg, "DASSL-- TOUT (=R1) TOO CLOSE TO T (=R2) TO START INTEGRATION",
	  80L, 60L);
  C2F (xerrwv) (msg, &c__60, &c__14, &c__0, &c__0, &c__0, &c__0, &c__2,
		tout, t, 80L);
  goto L750;
 L715:
  s_copy (msg, "DASSL--  INFO(4)=1 AND TSTOP (=R1) BEHIND T (=R2)", 80L, 49L);
  C2F (xerrwv) (msg, &c__49, &c__15, &c__0, &c__0, &c__0, &c__0, &c__2,
		&tstop, t, 80L);
  goto L750;
 L717:
  s_copy (msg, "DASSL--  ML (=I1) ILLEGAL. EITHER .LT. 0 OR .GT. NEQ", 80L,
	  52L);
  C2F (xerrwv) (msg, &c__52, &c__17, &c__0, &c__1, &iwork[1], &c__0,
		&c__0, &c_b30, &c_b30, 80L);
  goto L750;
 L718:
  s_copy (msg, "DASSL--  MU (=I1) ILLEGAL. EITHER .LT. 0 OR .GT. NEQ", 80L,
	  52L);
  C2F (xerrwv) (msg, &c__52, &c__18, &c__0, &c__1, &iwork[2], &c__0,
		&c__0, &c_b30, &c_b30, 80L);
  goto L750;
 L719:
  s_copy (msg, "DASSL--  TOUT (=R1) IS EQUAL TO T (=R2)", 80L, 39L);
  C2F (xerrwv) (msg, &c__39, &c__19, &c__0, &c__0, &c__0, &c__0, &c__2,
		tout, t, 80L);
  goto L750;
 L730:
  s_copy (msg, "DASSL--  NG (=I1) .LT. 0", 80L, 24L);
  C2F (xerrwv) (msg, &c__24, &c__30, &c__1, &c__1, ng, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  goto L750;
 L732:
  s_copy (msg, "DASSL--  ONE OR MORE COMPONENTS OF G HAS A ROOT", 80L, 47L);
  C2F (xerrwv) (msg, &c__47, &c__32, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  s_copy (msg, "         TOO NEAR TO THE INITIAL POINT", 80L, 38L);
  C2F (xerrwv) (msg, &c__38, &c__32, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
 L750:
  if (info[1] == -1)
    {
  ...
  *idid = -33;
  return 0;
 L760:
  s_copy (msg, "DASSL--  REPEATED OCCURRENCES OF ILLEGAL INPUT", 80L, 46L);
  C2F (xerrwv) (msg, &c__46, &c__801, &c__0, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  /* L770: */
  s_copy (msg, "DASSL--  RUN TERMINATED. APPARENT INFINITE LOOP", 80L, 47L);
  C2F (xerrwv) (msg, &c__47, &c__802, &c__1, &c__0, &c__0, &c__0, &c__0,
		&c_b30, &c_b30, 80L);
  return 0;
...
int
nsp_ode_drchek (int *job, dassl_g g, int *ng, int *neq, double *tn,
		   double *tout, double *y, double *yp, double *phi,
		   double *psi, int *kold, double *g0, double *g1, double *gx,
		   int *jroot, int *irt, double *uround, int *info3,
		   double *rwork, int *iwork, double *rpar, int *ipar)
{
  /* System generated locals */
...
*/
  ...
  *irt = 0;
   ...
   */
 L100:
  nsp_ode_ddatrp (tn, &rwork[41], &y[1], &yp[1], neq, kold,
 ...
 L300:
  ...
  nsp_ode_ddatrp (tn, &t1, &y[1], &yp[1], neq, kold, &phi[phi_offset],
		     &psi[1]);
  if (ierode_1.iero > 0)
    {
      return 0;
 ...
 L330:
  ...
  jflag = 0;
 L350:
  nsp_ode_droots (ng, &hming, &jflag, &rwork[41], &t1, &g0[1], &g1[1],
		     &gx[1], &x, &jroot[1], &iwork[20], &iwork[19],
		     &rwork[43], &rwork[44]);
  if (ierode_1.iero > 0)
    {
      return 0;
  ...
  nsp_ode_ddatrp (tn, &x, &y[1], &yp[1], neq, kold, &phi[phi_offset],
		     &psi[1]);
  if (ierode_1.iero > 0)
    {
      return 0;
...
int
nsp_ode_droots (int *ng, double *hmin, int *jflag, double *x0, double *x1,
		   double *g0, double *g1, double *gx, double *x, int *jroot,
		   int *imax, int *last, double *alpha, double *x2)
{
  /* Initialized data */
   ...
   * 
   *JROOT  = INT ARRAY OF LENGTH NG.  OUTPUT ONLY. 
