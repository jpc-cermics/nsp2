...
void signal_conv2_separable_R(double *R, int nR, double *C, int mC, double *A, int mA, int nA, double *Out, int mOut, int nOut, int edgM, int edgN, double *T)
{
...
void signal_conv2_separable_C(double *Rr, double *Ri, int nR, double *Cr, double *Ci, int mC, double *Ar, double *Ai, int mA, int nA, double *Outr, double *Outi, int mOut, int nOut, int edgM, int edgN, double *Tr, double *Ti)
{
  int ai = 0, tj = 0, ci = 0, rj = 0; /*current index over A,T,C and R */
  int i = 0, j = 0; /* loop variables*/
  int l = 0;
...
void signal_conv2_R(double *A, int mA, int nA, double *B, int mB, int nB, double *Out, int mOut, int nOut, int edgM, int edgN)
{
...
void signal_conv2_C(double *Ar, double *Ai, int mA, int nA, double *Br, double *Bi, int mB, int nB, double *Outr, double *Outi, int mOut, int nOut, int edgM, int edgN)
{
  int ai = 0, aj = 0, bi = 0, bj = 0; /*current index over A and B */
  int i = 0, j = 0; /* loop variables*/
  int l = 0;
