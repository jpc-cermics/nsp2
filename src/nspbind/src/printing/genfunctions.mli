...
val check_matchers:  Stringarg.function_params list -> string -> bool * string
val write_functions: (string, string) Hashtbl.t -> unit;;
val write_function_table:  Stringarg.function_obj list -> bool -> (string, 'a) Hashtbl.t -> string;;
