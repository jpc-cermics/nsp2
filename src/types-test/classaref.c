...
int int_classaref_create(Stack stack, int rhs, int opt, int lhs)
{
  ...
  if ( H->obj->cla_val == NULLMAT) {Scierror("Error: field cla_val is to be set\n");return RET_BUG;}
