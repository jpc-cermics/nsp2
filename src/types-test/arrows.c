...
static void nsp_draw_arrows(BCG *Xgc,NspGraphic *Obj);
...
#line 23 "codegen/arrows.override"
...
static NspArrows  *nsp_arrows_xdr_load(XDR *xdrs)
{
  ...
  if ((M  = nsp_arrows_create_void(name,(NspTypeBase *) nsp_type_arrows))== NULLARROWS) return M;
  return nsp_arrows_xdr_load_partial(xdrs,M);
}
 ...
 * functions 
 *-------------------------------------------*/
#line 46 "codegen/arrows.override"
...
#line 18 "codegen/arrows.override"
...
#line 110 "codegen/arrows.override"
