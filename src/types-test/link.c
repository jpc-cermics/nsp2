...
#line 172 "codegen/link.override"
 ...
 *-----------------------------------------------------*/
#line 237 "codegen/link.override"
...
#line 317 "codegen/link.override"
 ...
 * Methods
 *-------------------------------------------*/
#line 386 "codegen/link.override"
...
static void nsp_draw_link(BCG *Xgc,NspGraphic *Obj, const GdkRectangle *rect,void *data)
{
  ...
  cpat = Xgc->graphic_engine->xset_color(Xgc,
