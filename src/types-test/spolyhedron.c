...
#line 53 "codegen/spolyhedron.override"
...
static int nsp_spolyhedron_eq(NspSPolyhedron *A, NspObject *B)
{
  ...
  if ( A->obj->mesh_only != loc->obj->mesh_only) return FALSE;
...
int nsp_spolyhedron_xdr_save(XDR *xdrs, NspSPolyhedron *M)
{
  ...
  if (nsp_xdr_save_i(xdrs, M->obj->mesh_only) == FAIL) return FAIL;
...
NspSPolyhedron  *nsp_spolyhedron_xdr_load_partial(XDR *xdrs, NspSPolyhedron *M)
{
  ...
  if (nsp_xdr_load_i(xdrs, &M->obj->mesh_only) == FAIL) return NULL;
...
void nsp_spolyhedron_destroy_partial(NspSPolyhedron *H)
{
  ...
  if ( H->obj->ref_count == 0 )
   {
#line 81 "codegen/spolyhedron.override"
  /* verbatim in destroy */
  nsp_matrix_destroy(H->obj->Mcoord_l);

#line 351 "spolyhedron.c"
...
int nsp_spolyhedron_latex(NspSPolyhedron *M, int use_math,const char *name, int rec_level)
{
  ...
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|colmin|= \\numprint{%d}\n",M->obj->colmin);
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|colmax|= \\numprint{%d}\n",M->obj->colmax);
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|coloutmin|= \\numprint{%d}\n",M->obj->coloutmin);
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|coloutmax|= \\numprint{%d}\n",M->obj->coloutmax);
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|mesh|= %s\n",( M->obj->mesh == TRUE) ? "T" : "F" );
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|mesh_only|= %s\n",( M->obj->mesh_only == TRUE) ? "T" : "F" );
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|back_color|= \\numprint{%d}\n",M->obj->back_color);
  Sciprintf1(2,"\\\\\n");
  ...
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(2,"\\\\\n");
  Sciprintf1(indent+2,"\\verb|coldef|= \\numprint{%d}\n",M->obj->coldef);
  Sciprintf1(2,"\\\\\n");
...
NspSPolyhedron *nsp_spolyhedron_create_default(const char *name)
{
...
NspSPolyhedron *nsp_spolyhedron_full_copy_partial(NspSPolyhedron *H,NspSPolyhedron *self)
{
  ...
  H->obj->mesh_only=self->obj->mesh_only;
...
static NspObject *_wrap_spolyhedron_get_mesh_only(void *self,const char *attr)
{
  int ret;
  NspObject *nsp_ret;
  ret = ((NspSPolyhedron *) self)->obj->mesh_only;
  nsp_ret= (ret == TRUE) ? nsp_create_true_object(NVOID) : nsp_create_false_object(NVOID);
return nsp_ret;
}

static int _wrap_spolyhedron_set_mesh_only(void *self,const char *attr, NspObject *O)
{
  int mesh_only;
  if ( BoolScalar(O,&mesh_only) == FAIL) return FAIL;
  ((NspSPolyhedron *) self)->obj->mesh_only= mesh_only;
  return OK;
}
...
static AttrTab spolyhedron_attrs[] = {
  ...
  { "mesh_only", (attr_get_function * )_wrap_spolyhedron_get_mesh_only, (attr_set_function * )_wrap_spolyhedron_set_mesh_only, (attr_get_object_function * )int_get_object_failed, (attr_set_object_function * )int_set_object_failed },
 ...
 * functions 
 *-------------------------------------------*/
#line 86 "codegen/spolyhedron.override"
...
#line 106 "codegen/spolyhedron.override"
