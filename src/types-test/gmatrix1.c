...
#line 37 "codegen/gmatrix1.override"
...
#line 121 "gmatrix1.c"
  /* 
   * GMatrix1 interfaces can be added here 
...
/*----------------------------------------------
 * Object method redefined for GMatrix1 
 *-----------------------------------------------*/
/*
 * size 
 */
...
int nsp_gmatrix1_info(NspGMatrix1 *M,int indent,const char *name,int rec_level)
{
  ...
  if ( M == NULLGMATRIX1) 
    {
      Sciprintf("Null Pointer GMatrix1 \n");
      return TRUE;
    }
 ...
 * functions 
 *-------------------------------------------*/
#line 58 "codegen/gmatrix1.override"
...
#line 32 "codegen/gmatrix1.override"
...
#line 78 "codegen/gmatrix1.override"
...
static void nsp_translate_gmatrix1(BCG *Xgc,NspGraphic *Obj,double *tr)
{
  int i;
  NspGMatrix1 *P = (NspGMatrix1 *) Obj;
...
static void nsp_rotate_gmatrix1(BCG *Xgc,NspGraphic *Obj,double *R)
{
  /* nsp_figure_force_redraw(Obj->obj->Fig); */
}

static void nsp_scale_gmatrix1(BCG *Xgc,NspGraphic *Obj,double *alpha)
{
  int i;
  NspGMatrix1 *P = (NspGMatrix1 *) Obj;
  double *x=P->obj->x->R,*y= P->obj->y->R;
