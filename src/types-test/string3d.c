...
static void nsp_draw_string3d(BCG *Xgc,NspGraphic *Obj);
...
static NspString3d  *nsp_string3d_xdr_load(XDR *xdrs)
{
  ...
  if ((M  = nsp_string3d_create_void(name,(NspTypeBase *) nsp_type_string3d))== NULLSTRING3D) return M;
  return nsp_string3d_xdr_load_partial(xdrs,M);
}
