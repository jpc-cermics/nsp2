 ...
 *	None.
 *
 * err Error number (such as in errno variable).
 *----------------------------------------------------------------------
 */

char *nsp_error_msg(int err)
{
    switch (err) {
#ifdef E2BIG
