...
static char sp_short_type_name[]="spcol";
 ...
 *   added by Bruno
 */
static int int_spcolmatrix_multm(Stack stack, int rhs, int opt, int lhs)
{
...
static OpTab SpColMatrix_func[]={
  {"create_spcol",int_spcolmatrix_create},
  {"m2spcol",int_spcolmatrix_m2sp},
  {"spcol2m",int_spcolmatrix_sp2m},
  {"dst_spcol_spcol",int_spcolmatrix_multt},
  {"mult_spcol_spcol",int_spcolmatrix_mult},
  {"mult_spcol_m",int_spcolmatrix_multm},
  {"plus_spcol_spcol",int_spcolmatrix_plus},
  {"minus_spcol_spcol",int_spcolmatrix_sub},
  {"minus_spcol_m",int_spcolmatrix_sub},
  {"minus_m_spcol",int_spcolmatrix_sub},
  {"minus_spcol",int_spcolmatrix_minus},
  {"quote_spcol",int_spcolmatrix_quote},
  {"dprim_spcol", int_spcolmatrix_dquote},
  {"multt_spcol_spcol",int_spcolmatrix_multt}, 
  {"spcolredim",int_spcolmatrix_redim},
  {"concatd_spcol_spcol" ,  int_spcolmatrix_concatd },
  {"concatr_spcol_spcol" ,  int_spcolmatrix_concatr },
  {"concatdiag_spcol_spcol" ,  int_spcolmatrix_concatdiag },
  {"deletecols_spcol_m", int_spcolmatrix_deletecols},
  {"deleterows_spcol_m", int_spcolmatrix_deleterows},
  {"extract_spcol",int_spcolmatrix_extract},
  {"extractrows_spcol",int_spcolmatrix_extractrows},
  {"extractcols_spcol",int_spcolmatrix_extractcols},
  {"diage_spcol" ,  int_spcolmatrix_diage },
  {"diage_spcol_m" ,  int_spcolmatrix_diage },
  {"diagset_spcol" ,  int_spcolmatrix_diagset },
  {"diagcre_spcol" ,  int_spcolmatrix_diagcre },
  {"diagcre_spcol_m" ,  int_spcolmatrix_diagcre },
  {"diag_spcol", int_spcolmatrix_diag},
  {"diag_spcol_m", int_spcolmatrix_diag},
  {"sparsecol", int_spcolmatrix_sparse},
  {"spcolget", int_spcolmatrix_get},
  {"full_spcol",int_spcolmatrix_sp2m},
  {"sum_spcol_s" ,  int_spcolmatrix_sum },
  {"sum_spcol" ,  int_spcolmatrix_sum },
  {"setrowscols_spcol",int_spcolmatrix_setrc},
  {"maxi_spcol" ,  int_spcolmatrix_maxi },
  ...
  {"sin_spcol",int_spcolmatrix_sin},
  {"sinh_spcol",int_spcolmatrix_sinh},
  {"asin_spcol",int_spcolmatrix_asin},
  {"asinh_spcol",int_spcolmatrix_asinh},
  {"cos_spcol",int_spcolmatrix_cos},
  {"cosh_spcol",int_spcolmatrix_cosh},
  {"acos_spcol",int_spcolmatrix_acos},
  {"acosh_spcol",int_spcolmatrix_acosh},
  {"atan_spcol",int_spcolmatrix_atan},
  {"atanh_spcol",int_spcolmatrix_atanh},
  {"ceil_spcol",int_spcolmatrix_ceil},
  {"int_spcol",int_spcolmatrix_int},
  {"floor_spcol",int_spcolmatrix_floor},
  {"round_spcol",int_spcolmatrix_round},
  {"sign_spcol",int_spcolmatrix_sign},
  {"tan_spcol",int_spcolmatrix_tan},
  {"tanh_spcol",int_spcolmatrix_tanh},
  {"conj_spcol",int_spcolmatrix_conj},
  {"find_spcol", int_spcolmatrix_find},
  {"sqrt_spcol",int_spcolmatrix_sqrtel},
  {"log_spcol",int_spcolmatrix_logel},
  {"exp_spcol",int_spcolmatrix_expel},
  {(char *) 0, NULL}
};
