/* SB04QD.f -- translated by f2c (version 19961017).
 *   
...
/* Subroutine */ int
nsp_slicot_sb04qd (int *n, int *m, double *a, int *lda,
  ...
  *info = 0;
  ...
  if (blas3)
      ...
      for (i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
	{
	  ...
	  i__3 = *n - i__ + 1;
	  bl = Min (i__3, chunk);
	  C2F (dgemm) ("NoTranspose", "NoTranspose", &bl, m, m, &c_b11,
		       &c__[i__ + c_dim1], ldc, &z__[z_offset], ldz, &c_b12,
		       &dwork[jwork], &bl, 11L, 11L);
	  C2F (dlacpy) ("Full", &bl, m, &dwork[jwork], &bl,
			&c__[i__ + c_dim1], ldc, 4L);
	  /* L40: */
	}
      /* 
       */
 ...
 L80:
  ...
  if (ind > 1)
      ...
      if (b[ind + (ind - 1) * b_dim1] == 0.)
	{
	   ...
	   * 
	   */
	  nsp_slicot_sb04qy (m, n, &ind, &a[a_offset], lda, &b[b_offset], ldb,
      ...
      else
	{
	   ...
	   * 
	   */
	  nsp_slicot_sb04qu (m, n, &ind, &a[a_offset], lda, &b[b_offset], ldb,
			     &c__[c_offset], ldc, &dwork[jwork], &iwork[1],
			     info);
	  /* 
	   */
  ...
  C2F (dormhr) ("Left", "No transpose", n, m, &ilo, &ihi, &a[a_offset], lda,
		&dwork[itau], &c__[c_offset], ldc, &dwork[jwork], &i__2,
		&ifail, 4L, 12L);
  /*Computing MAX 
   */
  i__2 = wrkopt, i__1 = (int) dwork[jwork] + jwork - 1;
  ...
  if (blas3)
      ...
      for (i__ = 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
	{
	  ...
	  i__3 = *n - i__ + 1;
	  bl = Min (i__3, chunk);
	  C2F (dgemm) ("NoTranspose", "Transpose", &bl, m, m, &c_b11,
		       &c__[i__ + c_dim1], ldc, &z__[z_offset], ldz, &c_b12,
		       &dwork[jwork], &bl, 11L, 9L);
	  C2F (dlacpy) ("Full", &bl, m, &dwork[jwork], &bl,
			&c__[i__ + c_dim1], ldc, 4L);
	  /* L100: */
	}
