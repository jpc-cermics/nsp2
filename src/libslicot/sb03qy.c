/* SB03QY.f -- translated by f2c (version 19961017).
 *   
...
/* Subroutine */ int
nsp_slicot_sb03qy (char *job, char *trana, char *lyapun, int *n, double *t,
		   int *ldt, double *u, int *ldu, double *x,
		   int *ldx, double *sep, double *thnorm,
		   int *iwork, double *dwork, int *ldwork,
		   int *info, long int job_len, long int trana_len,
		   long int lyapun_len)
{
  /* System generated locals */
  int t_dim1, t_offset, u_dim1, u_offset, x_dim1, x_offset, i__1;
  ...
  if (!wants)
      ...
      if (kase != 0)
	{
	  ...
	  C2F (dsyr2k) (uplo, tranat, n, n, &c_b22, &dwork[1], n,
			&x[x_offset], ldx, &c_b21, &dwork[itmp], n, 1L, 1L);
