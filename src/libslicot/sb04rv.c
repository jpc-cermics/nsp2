/* SB04RV.f -- translated by f2c (version 19961017).
 *   
...
/* Subroutine */ int
nsp_slicot_sb04rv (char *abschr, char *ul, int *n, int *m, double *c__,
	  ...
	  if (*indx > 1)
	    {
	      ...
	      C2F (dgemv) ("N", n, &i__1, &c_b9, &c__[c_offset], ldc,
			   &ab[*indx * ab_dim1 + 1], &c__1, &c_b11, &dwork[1],
			   &c__1, 1L);
	      i__1 = *indx - 1;
	      C2F (dgemv) ("N", n, &i__1, &c_b9, &c__[c_offset], ldc,
			   &ab[(*indx + 1) * ab_dim1 + 1], &c__1, &c_b11,
			   &dwork[*n + 1], &c__1, 1L);
	      C2F (dgemv) ("N", n, n, &c_b19, &ba[ba_offset], ldba, &dwork[1],
			   &c__1, &c_b9, &d__[1], &c__2, 1L);
	      C2F (dgemv) ("N", n, n, &c_b19, &ba[ba_offset], ldba,
			   &dwork[*n + 1], &c__1, &c_b9, &d__[2], &c__2, 1L);
	    }
	}
      else
	{
	  ...
	  if (*indx < *n - 1)
	    {
	      ...
	      C2F (dgemv) ("T", m, m, &c_b19, &ba[ba_offset], ldba, &dwork[1],
			   &c__1, &c_b9, &d__[1], &c__2, 1L);
	      C2F (dgemv) ("T", m, m, &c_b19, &ba[ba_offset], ldba,
			   &dwork[*m + 1], &c__1, &c_b9, &d__[2], &c__2, 1L);
	    }
	}
      else
	{
	  if (*indx > 1)
	    {
	      ...
	      C2F (dgemv) ("T", &i__1, m, &c_b9, &c__[c_offset], ldc,
			   &ab[*indx + ab_dim1], ldab, &c_b11, &dwork[1],
			   &c__1, 1L);
	      i__1 = *indx - 1;
	      C2F (dgemv) ("T", &i__1, m, &c_b9, &c__[c_offset], ldc,
			   &ab[*indx + 1 + ab_dim1], ldab, &c_b11,
			   &dwork[*m + 1], &c__1, 1L);
	      C2F (dgemv) ("T", m, m, &c_b19, &ba[ba_offset], ldba, &dwork[1],
			   &c__1, &c_b9, &d__[1], &c__2, 1L);
	      C2F (dgemv) ("T", m, m, &c_b19, &ba[ba_offset], ldba,
