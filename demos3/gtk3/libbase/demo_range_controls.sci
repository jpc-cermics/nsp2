...
function demo_range_controls()
  ...
  scale = gtkscale_new("horizontal",adjustment=adjustment)
  ...
  scrollbar = gtkscrollbar_new("horizontal",adjustment=adjustment)
  ...
  scale = gtkscale_new ("vertical",adjustment=adjustment)
