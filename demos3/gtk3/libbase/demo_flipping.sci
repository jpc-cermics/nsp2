...
function demo_flipping ()
  ...
  window_vbox.pack_start[ check_button,expand=%t,fill=%t,padding=0];
  window_vbox.pack_start[ create_forward_back ("Default", GTK.TEXT_DIR_NONE)];
  window_vbox.pack_start[ create_forward_back ("Left-to-Right", GTK.TEXT_DIR_LTR)];
  window_vbox.pack_start[ create_forward_back ("Right-to-Left", GTK.TEXT_DIR_RTL)];
