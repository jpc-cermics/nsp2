...
//        UIobs=ui_observer(Sys,1,C1,D1);
  ...
  Sys1=linear_system(Sys.A,Sys.B(:,reject),Sys.C,Sys.D(:,reject),Sys.X0,dom=Sys.dom,sample=Sys.dt);
  ...
  UIobs= linear_system(UIobs.A,UIobs.B, [C12+N*C22], [D12+N*D22,-N],...
		       UIobs.X0,dom=UIobs.dom,sample=UIobs.dt);
endfunction
