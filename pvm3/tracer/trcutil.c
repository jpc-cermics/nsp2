...
int
trc_add_to_trie(TRC_TRIE T,char * str,void * value )
{
  TRC_TRIE tptr;
...
void *
trc_lookup_trie(TRC_TRIE T, char *str)
{
  TRC_TRIE tptr;
...
int
trc_cmp_did(TRC_DID did1, TRC_DID did2)
{
  if ( did1->id != did2->id )
    return( TRC_FALSE );
...
void
trc_free_datadesc(TRC_DATADESC *ptr)
{
  TRC_DATADESC DD;
...
int
trc_cmp_datadesc(TRC_DATADESC DD1,TRC_DATADESC DD2)
{
  TRC_DID D1, D2;
...
int
trc_free_tevdesc(TRC_TEVDESC *ptr)
{
  TRC_TEVDESC TD;
...
int
trc_cmp_tevdesc(TRC_TEVDESC TD1, TRC_TEVDESC TD2)
{
...
void
trc_remove_tevdesc(TRC_TEVDESC *ptr, int index)
{
  TRC_TEVDESC TDnext;
  TRC_TEVDESC TDlast;
  TRC_TEVDESC TDptr;
...
void
trc_free_event_descriptors(TRC_TRIE T)
{
  TRC_TRIE tptr;
...
void
trc_free_tevdesc_info(TRC_TEVDESC_INFO *ptr)
{
  TRC_TEVDESC_INFO TI;
...
void
trc_free_tevrec(TRC_TEVREC *ptr)
{
  TRC_TEVREC TR;
...
TRC_TEVREC
trc_get_tevrec(TRC_TEVREC TR, char *did)
{
  TRC_TEVREC trptr;
...
char *
trc_tevrec_string(TRC_TEVDESC TD,TRC_TEVREC TR,int tid,int tsec,int tusec)
{
  TRC_DATADESC DD;
...
TRC_VALUE
trc_copy_value(TRC_VALUE V, int dt, int num)
{
  TRC_VALUE tmp;
...
void
trc_check_for_dead_host(TRC_ID ID, TRC_TEVTASK TT)
{
  TRC_TEVTASK TTptr;
...
void
trc_free_tevtask(TRC_TEVTASK *ptr)
{
  TRC_TEVTASK TT;
...
void
trc_free_tevtask_list(TRC_TEVTASK *tevtask_list)
{
  TRC_TEVTASK TTnext;
  TRC_TEVTASK TT;
...
TRC_TEVTASK
trc_get_tevtask_tid(TRC_ID ID, int tid)
{
  TRC_TEVTASK TT;
...
TRC_HOST
trc_get_host_tid_last(int tid, TRC_HOST *last)
{
  TRC_HOST H;
...
int
trc_do_host_sync(TRC_ID ID,TRC_HOST H,int dump_event)
{
...
void
trc_initialize_hosts(TRC_ID ID)
{
  TRC_HOST H;
...
int
trc_handle_host_add_notify(TRC_ID ID,int *tids,int num)
{
  TRC_HOST H;
...
int
trc_handle_host_del_notify(TRC_ID ID, int tid)
{
  TRC_HOST Hlast;
  TRC_HOST H;
...
int
trc_update_host(TRC_HOST *Hret, struct pvmhostinfo *hostp,int index,int tid)
{
  TRC_HOST Hlast;
  TRC_HOST H;
...
void
trc_status_msg(TRC_ID ID, char *msg)
{
  if ( ID->status_msg )
...
int
trc_append_str(char *result, char *str, int maxlen)
{
  int rlen;
  int len;
  int rc;
...
int
trc_filecheck( FILE *fp, char *name)
{
  if ( fp == NULL )
    {
...
void
trc_memcheck( void *ptr, char *name)
{
  if ( ptr == NULL )
    {
