\chapter*{statistics}\addcontentsline{toc}{chapter}{random numbers, basic statistics, distribution functions}
...
\HCode{<hr>}
density, cumulative density (direct and inverse) functions
