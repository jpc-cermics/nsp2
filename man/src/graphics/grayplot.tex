...
\begin{parameters}
  \begin{varlist}
    ...
    \vname{remap}: If true then the \verb!z! values are scaled to match colors of the current colormap. 
    If false the values of \verb!z! are directly considered as colorid. The default value for \verb!remap! is true.
    \vname{shade}: If true the color in each rectangle of the surface are interpolated using colors at the 
