...
\begin{mandescription}
  ...
  \begin{itemize}
  \item \itemdesc{-1} : in this case the same color than in the neighbouring zone is used (CAUTION:
    you don't see that the corresponding limit is crossed), this is the default case.
  \item \itemdesc{0} : in this case the extreme region is not painted at all.
  \item \itemdesc{k} : (k being a valid index to a color of the current colormap) the extreme region
