...
\mansection{int2d}
\begin{mandesc}
  \short{int2d}{two dimensional integration over a set of triangles}
\end{mandesc}
...
\begin{parameters}
  \begin{varlist}
    \vname{X,Y}:  $3 \times n$ arrays, respectively the abscissae and
...
belong in the unit square and so you can use int2d with 2 triangles
