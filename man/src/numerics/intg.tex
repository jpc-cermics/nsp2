...
\begin{parameters}
  \begin{varlist}
    ...
    \vname{args=cpar}: optional named argument, useful to pass
...
\verb+ea_estim+ is a computed estimation of $| I - I_a |$. The \verb+ier+ 
variable could take values from 0 to 5: 
\begin{itemize}
...
[Ia,ea,ier] = intg(0,1,f, sing=0) // exact result is -2
Ia-2
\end{Verbatim}
