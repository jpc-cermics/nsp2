...
%--example 
\begin{examples}
  \begin{program}\HCode{f1=['int ext1c(n, a, b, c)'\Hnewline
         'int *n;     double *a, *b, *c;'\Hnewline
         '{int k;'\Hnewline
         '  for (k = 0; k $<$ *n; ++k) '\Hnewline
         '      c[k] = a[k] + b[k];'\Hnewline
         '  return(0);}'];\Hnewline
    mputl(f1,'fun1.c')\Hnewline
    //creating the shared library (a gateway, a Makefile and a loader are \Hnewline
    //generated. \Hnewline
    ilib_for_link('ext1c','fun1.o',[],"c") \Hnewline
    // load the shared library \Hnewline
    exec loader.sce \Hnewline
    //using the new primitive\Hnewline
    a=[1,2,3];b=[4,5,6];n=3;\Hnewline
    c=call('ext1c',n,1,'i',a,2,'d',b,3,'d','out',[1,3],4,'d');\Hnewline
