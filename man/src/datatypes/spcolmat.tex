...
\itemdesc{Methods}
\begin{itemize}
\item \verb+S.scale_rows[x]+ multiplies each row i of A with a scalar (see \manlink{scale_rows}{scale_rows}) 
\item \verb+S.scale_cols[x]+ multiplies each column j of A with a scalar (see \manlink{scale_cols}{scale_cols})
