...
\begin{parameters}
  \begin{varlist}
    \vname{mode}: The argument mode is a string beginning  with  one  of  the  following  sequences
    \begin{itemize}
...
\begin{itemize}
  ...
  \vname{F.print}: A revoir pour metre en accord avec les fonctions asspciées.
  \vname{F.printf}:A revoir pour metre en accord avec les fonctions asspciées.
\end{itemize}
