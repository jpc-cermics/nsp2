...
Selected with  \verb+match="i"+, in this case, the function searches,
...
\begin{examples}
  ...
  example with numbers and interval matching:
  \begin{program}
    x=grand(1000,1,"def");
  ...
  an example with strings and exact matching:
  \begin{program}
    x = ["toto","est","un","foo"];
  ...
  an example with strings and interval matching:
  \begin{program}
    m = 5000;
    x = smat_create(m,1);
