...
\mansection{pbig}
\begin{mandesc}
  \short{pbig}{eigen-projection} \\ % 
\end{mandesc}
%\index{pbig}\label{pbig}
...
%-- see also
\begin{manseealso}
  \manlink{psmall}{psmall} \manlink{projspec}{projspec} \manlink{fullrf}{fullrf} \manlink{schur}{schur}  
\end{manseealso}
%-- Author
\begin{authors}
  François Delebecque
\end{authors}
\verb!pbig! is based on the ordered schur form (scilab
function \verb!schur!).
