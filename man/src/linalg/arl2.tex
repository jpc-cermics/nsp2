...
\begin{parameters}
  \begin{varlist}
    ...
    \vname{den}: polynomial or vector of polynomials, contains the denominator(s) of the solution(s)
    \vname{num}: polynomial or vector of polynomials, contains the numerator(s) of the solution(s)
    \vname{err}: real constant or vector , the l2-error achieved for each solutions
  \end{varlist}
\end{parameters}
