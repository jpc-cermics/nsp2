...
[Q,R]=qr(A);
if Err(Q*R-A)> 3000*%eps then pause,end
...
[Q,R,x]=qr(A);
if Err(Q*R-A(:,x))> 3000*%eps then pause,end
...
//Complex case
Q=qr(Ac);
if Err(Q*Q'-eye(size(Q*Q')))> 3000*%eps then pause,end
Q=qr(Ac,mode="e");
if Err(Q'*Q-eye(size(Q'*Q)))> 3000*%eps then pause,end

[Q,R]=qr(Ac);
if Err(Q*R-Ac)> 3000*%eps then pause,end
[Q,R]=qr(Ac,mode="e");
if Err(Q*R-Ac)> 3000*%eps then pause,end
if Err(Q'*Q-eye(size(Q'*Q)))> 3000*%eps then pause,end
...
[Q,R,x]=qr(Ac);
if Err(Q*R-Ac(:,x))> 3000*%eps then pause,end
[Q,R,x]=qr(Ac,mode="e");
if Err(Q*R-Ac(:,x))> 3000*%eps then pause,end

Act=Ac';
[Q,R,x]=qr(Act);
if Err(Q*R-Act(:,x))> 3000*%eps then pause,end
[Q,R,x]=qr(Act,mode="e");
if Err(Q*R-Act(:,x))> 3000*%eps then pause,end

//Rank detection (obsolete)
[Q,R,x,rk]=qr(A);
if Err(Q*R-A(:,x))> 3000*%eps | rk<>60  then pause,end
[Q,R,x,rk]=qr(A,tol=1.d-8);
if Err(Q*R-A(:,x))> 3000*%eps | rk<>60  then pause,end

[Q,R,x,rk]=qr(Ac);
if Err(Q*R-Ac(:,x))> 3000*%eps | rk<>60  then pause,end
